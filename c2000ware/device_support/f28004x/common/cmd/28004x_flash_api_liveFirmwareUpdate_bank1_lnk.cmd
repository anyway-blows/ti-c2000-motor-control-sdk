...
PAGE 0 :
   ...
   FLASH_BANK1_SEC2  : origin = 0x092008, length = 0x000FF8	/* on-chip Flash */
   ...
   FLASH_BANK1_SEC14 : origin = 0x09E000, length = 0x000FF0	/* on-chip Flash */
   FLASH_BANK1_SEC15 : origin = 0x09EFF2, length = 0x000FFE	/* on-chip Flash */
...
SECTIONS
{
   ...
   .text            : >>FLASH_BANK1_SEC2 | FLASH_BANK1_SEC3 | FLASH_BANK1_SEC4,   PAGE = 0, ALIGN(4)
   .cinit           : > FLASH_BANK1_SEC2,     PAGE = 0, ALIGN(4)
   .pinit           : > FLASH_BANK1_SEC2,     PAGE = 0, ALIGN(4)
   .switch          : > FLASH_BANK1_SEC2,     PAGE = 0, ALIGN(4)
