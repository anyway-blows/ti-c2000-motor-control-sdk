...
PAGE 0 :
   ...
   FLASH_BANK1_SEC1  : origin = 0x091017, length = 0x000FE9	/* on-chip Flash */
...
SECTIONS
{
   ...
   .text            : >>FLASH_BANK1_SEC0 | FLASH_BANK1_SEC1,   PAGE = 0, ALIGN(4)
   ...
   .TI.ramfunc      : LOAD = FLASH_BANK1_SEC0,
                         ...
                         PAGE = 0, ALIGN(4)
  LDFU_BANK1        : > BANK1_SEC1,     PAGE = 0, ALIGN(4)
