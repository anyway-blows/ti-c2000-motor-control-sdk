...
{
   /* Flash sectors */
   CMBANK0_SECURERESET : origin = 0x00200000, length = 0x00000004 /* Boot to Secure Flash Entry Point */
   CMBANK0_SECTOR0  : origin = 0x00200004, length = 0x00003FFC
...
SECTIONS
{
   .secureReset     : > CMBANK0_SECURERESET
   .resetisr        : > CMBANK0_SECTOR0
