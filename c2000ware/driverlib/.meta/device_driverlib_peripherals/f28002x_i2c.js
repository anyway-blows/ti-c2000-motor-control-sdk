let I2C_InterruptSource = [
	...
	{ name: "I2C_INTSRC_ADDR_SLAVE", displayName: "Addressed as slave interrupt" },
]
let I2C_TxFIFOLevel = [
...
let I2C_EmulationMode = [
	{ name: "I2C_EMULATION_STOP_SCL_LOW", displayName: "EMULATION STOP SCL LOW" },
	{ name: "I2C_EMULATION_FREE_RUN", displayName: "EMULATION FREE RUN" },
]
let I2C_DutyCycle = [
