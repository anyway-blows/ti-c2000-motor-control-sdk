...
let EPWM_SyncOutPulseMode = [
	{ name: "EPWM_SYNC_OUT_PULSE_ON_SOFTWARE", displayName: "SYNC OUT PULSE ON SOFTWARE" },
	{ name: "EPWM_SYNC_OUT_PULSE_ON_EPWMxSYNCIN", displayName: "SYNC OUT PULSE ON EPWMXSYNCIN" },
	{ name: "EPWM_SYNC_OUT_PULSE_ON_COUNTER_ZERO", displayName: "SYNC OUT PULSE ON COUNTER ZERO" },
	{ name: "EPWM_SYNC_OUT_PULSE_ON_COUNTER_COMPARE_B", displayName: "SYNC OUT PULSE ON COUNTER COMPARE B" },
	{ name: "EPWM_SYNC_OUT_PULSE_DISABLED", displayName: "SYNC OUT PULSE DISABLED" },
	{ name: "EPWM_SYNC_OUT_PULSE_ON_COUNTER_COMPARE_C", displayName: "SYNC OUT PULSE ON COUNTER COMPARE C" },
	{ name: "EPWM_SYNC_OUT_PULSE_ON_COUNTER_COMPARE_D", displayName: "SYNC OUT PULSE ON COUNTER COMPARE D" },
]
