let CLA_BGTaskStatus = [
	{ name: "CLA_BGSTS_RUNNING", displayName: "BGSTS RUNNING" },
	{ name: "CLA_BGSTS_CANNOT_INTERRUPT", displayName: "BGSTS CANNOT INTERRUPT" },
	{ name: "CLA_BGSTS_OVERFLOW", displayName: "BGSTS OVERFLOW" },
]
let CLA_TaskNumber = [
...
let CLA_Trigger = [
	...
	{ name: "CLA_TRIGGER_EPWM13INT", displayName: "CLA Task Trigger Source is EPWM13INT" },
	{ name: "CLA_TRIGGER_EPWM14INT", displayName: "CLA Task Trigger Source is EPWM14INT" },
	{ name: "CLA_TRIGGER_EPWM15INT", displayName: "CLA Task Trigger Source is EPWM15INT" },
	{ name: "CLA_TRIGGER_EPWM16INT", displayName: "CLA Task Trigger Source is EPWM16INT" },
	...
	{ name: "CLA_TRIGGER_ECATSYNC0INT", displayName: "CLA Task Trigger Src is ECATSYNC0INT" },
	{ name: "CLA_TRIGGER_ECATSYNC1INT", displayName: "CLA Task Trigger Src is ECATSYNC1INT" },
	...
	{ name: "CLA_TRIGGER_SPITXDINT", displayName: "CLA Task Trigger Source is SPITXDINT" },
	{ name: "CLA_TRIGGER_SPIRXDINT", displayName: "CLA Task Trigger Source is SPIRXDINT" },
	{ name: "CLA_TRIGGER_CLB5INT", displayName: "CLA Task Trigger Source is CLB5INT" },
	{ name: "CLA_TRIGGER_CLB6INT", displayName: "CLA Task Trigger Source is CLB6INT" },
	{ name: "CLA_TRIGGER_CLB7INT", displayName: "CLA Task Trigger Source is CLB7INT" },
	{ name: "CLA_TRIGGER_CLB8INT", displayName: "CLA Task Trigger Source is CLB8INT" },
	...
	{ name: "CLA_TRIGGER_FSITXBINT1", displayName: "CLA Task Trigger Source is FSITXBINT1" },
	{ name: "CLA_TRIGGER_FSITXBINT2", displayName: "CLA Task Trigger Source is FSITXBINT2" },
	{ name: "CLA_TRIGGER_FSIRXBINT1", displayName: "CLA Task Trigger Source is FSIRXBINT1" },
	{ name: "CLA_TRIGGER_FSIRXBINT2", displayName: "CLA Task Trigger Source is FSIRXBINT2" },
	{ name: "CLA_TRIGGER_FSIRXCINT1", displayName: "CLA Task Trigger Source is FSIRXCINT1" },
	{ name: "CLA_TRIGGER_FSIRXCINT2", displayName: "CLA Task Trigger Source is FSIRXCINT2" },
	{ name: "CLA_TRIGGER_FSIRXDINT1", displayName: "CLA Task Trigger Source is FSIRXDINT1" },
	{ name: "CLA_TRIGGER_FSIRXDINT2", displayName: "CLA Task Trigger Source is FSIRXDINT2" },
	{ name: "CLA_TRIGGER_FSIRXEINT1", displayName: "CLA Task Trigger Source is FSIRXEINT1" },
	{ name: "CLA_TRIGGER_FSIRXEINT2", displayName: "CLA Task Trigger Source is FSIRXEINT2" },
	{ name: "CLA_TRIGGER_FSIRXFINT1", displayName: "CLA Task Trigger Source is FSIRXFINT1" },
	{ name: "CLA_TRIGGER_FSIRXFINT2", displayName: "CLA Task Trigger Source is FSIRXFINT2" },
	{ name: "CLA_TRIGGER_FSIRXGINT1", displayName: "CLA Task Trigger Source is FSIRXGINT1" },
	{ name: "CLA_TRIGGER_FSIRXGINT2", displayName: "CLA Task Trigger Source is FSIRXGINT2" },
	{ name: "CLA_TRIGGER_FSIRXHINT1", displayName: "CLA Task Trigger Source is FSIRXHINT1" },
	{ name: "CLA_TRIGGER_FSIRXHINT2", displayName: "CLA Task Trigger Source is FSIRXHINT2" },
]
exports = {
