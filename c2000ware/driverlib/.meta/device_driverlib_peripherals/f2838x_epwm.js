...
let EPWM_SyncInPulseSource = [
	...
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM8", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM8" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM9", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM9" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM10", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM10" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM11", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM11" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM12", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM12" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM13", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM13" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM14", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM14" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM15", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM15" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM16", displayName: "SYNC IN PULSE SRC SYNCOUT EPWM16" },
	...
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_ECAP4", displayName: "SYNC IN PULSE SRC SYNCOUT ECAP4" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_ECAP5", displayName: "SYNC IN PULSE SRC SYNCOUT ECAP5" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_ECAP6", displayName: "SYNC IN PULSE SRC SYNCOUT ECAP6" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_ECAP7", displayName: "SYNC IN PULSE SRC SYNCOUT ECAP7" },
	...
	{ name: "EPWM_SYNC_IN_PULSE_SRC_ETHERCAT_SYNC0", displayName: "SYNC IN PULSE SRC ETHERCAT SYNC0" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_ETHERCAT_SYNC1", displayName: "SYNC IN PULSE SRC ETHERCAT SYNC1" },
]
...
let EPWM_DigitalCompareCBCLatchMode = [
	{ name: "EPWM_DC_CBC_LATCH_DISABLED", displayName: "DC CBC LATCH DISABLED" },
	{ name: "EPWM_DC_CBC_LATCH_ENABLED", displayName: "DC CBC LATCH ENABLED" },
]
let EPWM_DigitalCompareCBCLatchClearEvent = [
	{ name: "EPWM_DC_CBC_LATCH_CLR_CNTR_ZERO", displayName: "DC CBC LATCH CLR CNTR ZERO" },
	{ name: "EPWM_DC_CBC_LATCH_CLR_ON_CNTR_PERIOD", displayName: "DC CBC LATCH CLR ON CNTR PERIOD" },
	{ name: "EPWM_DC_CBC_LATCH_CLR_ON_CNTR_ZERO_PERIOD", displayName: "DC CBC LATCH CLR ON CNTR ZERO PERIOD" },
]
