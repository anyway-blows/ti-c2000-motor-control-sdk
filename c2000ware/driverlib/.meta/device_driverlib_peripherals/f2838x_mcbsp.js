...
let McBSP_RxInterruptSource = [
	{ name: "MCBSP_RX_ISR_SOURCE_SERIAL_WORD", displayName: "nterrupt when Rx is ready." },
	{ name: "MCBSP_RX_ISR_SOURCE_END_OF_BLOCK", displayName: "nterrupt at block end." },
	{ name: "MCBSP_RX_ISR_SOURCE_FRAME_SYNC", displayName: "nterrupt when" },
	{ name: "MCBSP_RX_ISR_SOURCE_SYNC_ERROR", displayName: "nterrupt on" },
]
...
let McBSP_TxInterruptSource = [
	{ name: "MCBSP_TX_ISR_SOURCE_TX_READY", displayName: "nterrupt when Tx Ready." },
	{ name: "MCBSP_TX_ISR_SOURCE_END_OF_BLOCK", displayName: "nterrupt at block end." },
	{ name: "MCBSP_TX_ISR_SOURCE_FRAME_SYNC", displayName: "nterrupt when frame" },
	{ name: "MCBSP_TX_ISR_SOURCE_SYNC_ERROR", displayName: "nterrupt on frame sync" },
]
...
let McBSP_TxFrameSyncPolarity = [
	{ name: "MCBSP_TX_FRAME_SYNC_POLARITY_HIGH", displayName: "ulse active high." },
	{ name: "MCBSP_TX_FRAME_SYNC_POLARITY_LOW", displayName: "ulse active low." },
]
let McBSP_RxFrameSyncPolarity = [
	{ name: "MCBSP_RX_FRAME_SYNC_POLARITY_HIGH", displayName: "ulse active high." },
	{ name: "MCBSP_RX_FRAME_SYNC_POLARITY_LOW", displayName: "ulse active low." },
]
