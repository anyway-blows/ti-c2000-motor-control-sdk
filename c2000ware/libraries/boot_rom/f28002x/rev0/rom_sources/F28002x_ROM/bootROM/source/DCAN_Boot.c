                   ...
                   uint16_t switchToXTAL)
{
    ...
    {
        bitTimingRegValue = (uint32_t)CAN_CALC_BTRREG;
    }
...
static void DCAN_Boot_GPIO(uint32_t bootMode)
{
    ...
    switch (bootMode)
    {
        ...
        case CAN_BOOT_ALT1_SENDTEST:
            ...
            gpioTx = 32;
            gpioRx = 33;
            gpioTxPinConfig = GPIO_32_CANTXA;
            gpioRxPinConfig = GPIO_33_CANRXA;
        ...
        case CAN_BOOT_ALT2_SENDTEST:
            ...
            gpioTx = 2;
            gpioRx = 3;
            gpioTxPinConfig = GPIO_2_CANTXA;
            gpioRxPinConfig = GPIO_3_CANRXA;
