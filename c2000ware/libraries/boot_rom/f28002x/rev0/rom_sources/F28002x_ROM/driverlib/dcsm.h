...
//*****************************************************************************
//
//! Force RAMOPEN and clear the unsecure RAMs
//!
...
DCSM_forceRAMOPEN(void)
{
    ...
    // Set the RAMOPEN bit
    //
    HWREG(DCSMCOMMON2_BASE + DCSM_O_RAMOPENFRC) = ((uint32_t)FORCE_RAMOPEN_KEY
...
//! mode. When this bits is written with '1', hardware wipes out all the
//! secured RAM content using RAMINIT feature and then clears the
//! RAMOPENSTAT.RAMOPEN bit after completion of RAMINIT for all the
//! secured RAMs.
//!
//! \return None.
//
...
DCSM_clearRAMOPEN(void)
{
    ...
    //
    HWREG(DCSMCOMMON2_BASE + DCSM_O_RAMOPENCLR) = ((uint32_t)CLEAR_RAMOPEN_KEY
...
//*****************************************************************************
static inline void
DCSM_lockRAMOPEN(void)
{
    EALLOW;

    HWREG(DCSMCOMMON2_BASE + DCSM_O_RAMOPENLOCK) |= DCSM_RAMOPENLOCK_LOCK;
...
{
    return(HWREGH(DCSMCOMMON2_BASE + DCSM_O_RAMOPENSTAT) &
