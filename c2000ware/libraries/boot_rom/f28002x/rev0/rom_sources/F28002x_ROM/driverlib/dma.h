...
//*****************************************************************************
//
//! Registers a receive interrupt handler for the DMA channel.
//!
//! \param base is the base address of the DMA channel control registers.
//! \param handler is a pointer to the function to be called when the
//! interrupt occurs.
//!
//! This function registers the handler to be called when an DMA channel
//! interrupt occurs.  This function enables the global interrupt in the
//! interrupt controller; specific DMA interrupts must be enabled via
//! DMA_enableInterrupt().  If necessary, it is the interrupt handler's
//! responsibility to clear the interrupt source via DMA_clearInterruptStatus().
//!
...
//*****************************************************************************
//
//! Unregisters a receive interrupt handler for the DMA channel.
//!
//! \param base is the base address of the DMA channel control registers.
//!
//! This function clears the handler to be called when a DMA channel interrupt
