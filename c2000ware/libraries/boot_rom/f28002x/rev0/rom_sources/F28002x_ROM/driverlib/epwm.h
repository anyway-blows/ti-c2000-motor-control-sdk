...
//*****************************************************************************
//
//! Registers ePWM interrupt handler
//!
...
//!
//! This function registers the handler to be called when an ePWM interrupt
//! occurs.  This function enables the global interrupt in the interrupt
//! controller.
//! Specific ePWM interrupts must be enabled via EPWM_enableInterrupt().
//! If necessary, it is the interrupt handler's responsibility
//! to clear the interrupt source via EPWM_clearInterrupt().
//!
...
//
//*****************************************************************************
extern void EPWM_registerInterrupt(uint32_t base,
                                                 void (*handler)(void));

//*****************************************************************************
//
//! Registers Trip Zone interrupt handler
//!
//! \param base is the base address of the ePWM instance used.
//! \param handler is a pointer to the function to be called when the
//! serial peripheral interface interrupt occurs.
//!
//! This function registers the handler to be called when a Trip Zone interrupt
//! occurs.  This function enables the global interrupt in the interrupt
//! controller.
//!
//! \sa Interrupt_register() for important information about registering
...
//
//*****************************************************************************
extern void EPWM_registerTripZoneInterrupt(uint32_t base,
                                                        void (*handler)(void));

//*****************************************************************************
//
//! Un-registers ePWM interrupt handler.
//!
//! \param base is the base address of the ePWM instance used.
//!
//! This function clears the handler to be called when an ePWM interrupt
...
//
//*****************************************************************************
extern void EPWM_unregisterInterrupt(uint32_t base);

//*****************************************************************************
//
//! Un-registers Trip Zone interrupt handler.
//!
//! \param base is the base address of the ePWM instance used.
//!
//! This function clears the handler to be called when a Trip Zone interrupt
//! occurs.  This function also masks off the interrupt in the interrupt
//! controller so that the interrupt handler no longer is called.
//!
//! \sa Interrupt_register() for important information about registering
...
//
//*****************************************************************************
extern void EPWM_unregisterTripZoneInterrupt(uint32_t base);
//*****************************************************************************
//
