...
GPIO_readPinDataRegister(uint32_t pin)
{
    ...
    gpioDataReg = (uint32_t *)GPIODATAREAD_BASE +
...
//*****************************************************************************
//
//! Registers an interrupt handler for an external interrupt.
//!
//! \param extIntNum specifies the external interrupt.
//! \param handler is a pointer to the external interrupt handling function.
//!
...
//! external interrupt.  This function also enables the corresponding external
//! interrupt in the interrupt controller; the interrupt source must be enabled
//! with GPIO_enableInterrupt().
//!
...
//*****************************************************************************
//
//! Removes an interrupt handler for an external interrupt.
//!
//! \param extIntNum specifies the external interrupt.
//!
//! This function unregisters the interrupt handler for the specified
//! external interrupt.  This function also disables the corresponding external
//! interrupt in the interrupt controller; the interrupt source must be
//! disabled with GPIO_disableInterrupt().
//!
//! \sa Interrupt_unregister() for important information about unregistering
//! interrupt handlers.
//!
//! \return None.
//
