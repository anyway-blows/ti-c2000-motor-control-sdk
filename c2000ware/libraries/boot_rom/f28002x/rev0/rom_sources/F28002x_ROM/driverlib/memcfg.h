...
#define MEMCFG_PROT_ALLOWHICWRITE   0x00000000U //!< CPU write allowed (GSxRAM)
#define MEMCFG_PROT_BLOCKHICWRITE   0x00000008U //!< CPU write blocked (GSxRAM)
...
//*****************************************************************************
//
//! Registers an interrupt handler for the RAM access violation interrupt.
//!
//! \param handler is a pointer to the function to be called when the RAM
//! access violation interrupt occurs.
//!
//! This function registers the handler to be called when a RAM access
//! violation interrupt occurs.  This function enables the global interrupt in
//! the interrupt controller; specific RAM access violation interrupts must be
//! enabled via MemCfg_enableViolationInterrupt().  It is the interrupt
...
//*****************************************************************************
//
//! Unregisters an interrupt handler for the RAM access violation interrupt.
//!
//! This function unregisters the handler to be called when a RAM access
//! violation interrupt occurs.  This function also masks off the interrupt in
...
//*****************************************************************************
//
//! Unregisters an interrupt handler for the RAM correctable error interrupt.
//!
//! This function unregisters the handler to be called when a RAM correctable
//! error interrupt occurs.  This function also masks off the interrupt in the
