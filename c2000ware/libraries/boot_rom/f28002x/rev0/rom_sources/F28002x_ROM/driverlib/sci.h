...
//*****************************************************************************
//
//! Gets the RX interrupt vector for the specific SCI port.
//!
//! \param base is the base address of the SCI port.
//!
//! \return Returns the RX interrupt vector for the SCI port.
//
//*****************************************************************************
extern uint32_t
...
//*****************************************************************************
//
//! Gets the TX interrupt vector for the specific SCI port.
//!
//! \param base is the base address of the SCI port.
//!
//! \return Returns the TX interrupt vector for the SCI port.
//
//*****************************************************************************
extern uint32_t
...
//*****************************************************************************
//
//! Registers an interrupt handler for a SCI RX interrupt.
//!
//! \param base is the base address of the SCI port.
//! \param handler is a pointer to the function to be called when the
//! SCI interrupt occurs.
//!
//! This function does the actual registering of the interrupt handler.  This
//! will enable the global interrupt in the interrupt controller; specific SCI
//! interrupts must be enabled via SCI_enableInterrupt().  It is the interrupt
...
//*****************************************************************************
//
//! Registers an interrupt handler for a SCI TX interrupt.
//!
//! \param base is the base address of the SCI port.
//! \param handler is a pointer to the function to be called when the
//! SCI interrupt occurs.
...
//*****************************************************************************
//
//! Unregisters an interrupt handler for a SCI RX interrupt.
//!
//! \param base is the base address of the SCI port.
//!
//! This function does the actual unregistering of the interrupt handler.  It
//! will clear the handler to be called when a SCI interrupt occurs.  This
...
//*****************************************************************************
//
//! Unregisters an interrupt handler for a SCI TX interrupt.
//!
//! \param base is the base address of the SCI port.
//!
//! This function does the actual unregistering of the interrupt handler.  It
