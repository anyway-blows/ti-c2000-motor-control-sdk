...
typedef enum
{
    ...
    SYSCTL_PERIPH_CLK_LINB       = 0x0113,  //!< LINB clock
	...
	// PCLKCR24
    SYSCTL_PERIPH_CLK_CPUCRC     = 0x0018,  //!< CPU CRC clock
	
	// PCLKCR25
    SYSCTL_PERIPH_CLK_HICA       = 0x0019   //!< HIC clock
...
typedef enum
{
    ...
    SYSCTL_PERIPH_RES_LINB       = 0x0113,  //!< Reset LINB
	...
	// SOFTPRES22
    SYSCTL_PERIPH_RES_PBIST_0    = 0x0116,  //!< Reset PBIST
	
	// SOFTPRES24
    SYSCTL_PERIPH_RES_CPUCRC     = 0x0118,  //!< Reset CPU CRC
...
typedef enum
{
    ...
    SYSCTL_PERIPH_PRESENT_I2CB   = 0x0109,
    ...
    SYSCTL_PERIPH_PRESENT_LINB   = 0x0116,

    // DC24
    SYSCTL_PERIPH_PRESENT_PMBUSA = 0x0017,

    // DC25
    SYSCTL_PERIPH_PRESENT_DCC0   = 0x0018,
    SYSCTL_PERIPH_PRESENT_DCC1   = 0x0118,
	
	// DC28
	SYSCTL_PERIPH_PRESENT_HICA   = 0x001B,
...
typedef enum
{
    ...
    SYSCTL_ACCESS_LIN_B           = 0x13A,  //!< LINB access
...
typedef enum
{
    ...
    SYSCTL_ACCESS_HICA  = 6U    //!< HICA access to the peripheral
} SysCtl_AccessMaster;
//*****************************************************************************
//
//! The following are values that can be passed to
