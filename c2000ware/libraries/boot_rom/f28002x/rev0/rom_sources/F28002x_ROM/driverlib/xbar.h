...
#define XBAR2_OUTPUT_CFG_REG_BASE  (OUTPUTXBAR2_BASE + \
                                    XBAR_O_OUTPUT1MUX0TO15CFG)
#define XBAR2_OUTPUT_EN_REG_BASE   (OUTPUTXBAR2_BASE + XBAR_O_OUTPUT1MUXENABLE)
...
#define XBAR2_INPUT_BASE          (INPUTXBAR2_BASE + XBAR_O_INPUT1SELECT)
...
//OUTPUT - XBAR1
    ...
    XBAR_OUT_MUX01_CLB1_4_1                = 0x0202,
    ...
    XBAR_OUT_MUX03_CLB1_5_1                = 0x0602,
    ...
    XBAR_OUT_MUX05_CLB2_4_1                = 0x0A02,
    ...
    XBAR_OUT_MUX07_CLB2_5_1                = 0x0E02,
    ...
    XBAR_OUT_MUX09_CLB3_4_1                = 0x1202,
    ...
    XBAR_OUT_MUX11_CLB3_5_1                = 0x1602,
    ...
    XBAR_OUT_MUX27_CLB7_5_1                = 0x3603,
    ...
    XBAR_OUT_MUX29_CLB8_4_1                = 0x3A03,
    XBAR_OUT_MUX30_SD2FLT4_COMPH           = 0x3C00,
    XBAR_OUT_MUX30_SD2FLT4_COMPH_OR_COMPL  = 0x3C01,
    XBAR_OUT_MUX31_SD2FLT4_COMPL           = 0x3E00,
    XBAR_OUT_MUX31_CLB8_5_1                = 0x3E03,
//OUTPUT - XBAR2
    XBAR2_OUT_MUX0_CLB1_OUT0               = 0x0000,
    XBAR2_OUT_MUX0_CLB5_OUT0               = 0x0001,
    XBAR2_OUT_MUX1_CLB1_OUT1               = 0x0200,
    XBAR2_OUT_MUX1_CLB5_OUT1               = 0x0201,
    XBAR2_OUT_MUX2_CLB1_OUT2               = 0x0400,
    XBAR2_OUT_MUX2_CLB5_OUT2               = 0x0401,
    XBAR2_OUT_MUX3_CLB1_OUT3               = 0x0600,
    XBAR2_OUT_MUX3_CLB5_OUT3               = 0x0601,
    XBAR2_OUT_MUX4_CLB1_OUT4               = 0x0800,
    XBAR2_OUT_MUX4_CLB5_OUT4               = 0x0801,
    XBAR2_OUT_MUX5_CLB1_OUT5               = 0x0A00,
    XBAR2_OUT_MUX5_CLB5_OUT5               = 0x0A01,
    XBAR2_OUT_MUX6_CLB1_OUT6               = 0x0C00,
    XBAR2_OUT_MUX6_CLB5_OUT6               = 0x0C01,
    XBAR2_OUT_MUX7_CLB1_OUT7               = 0x0E00,
    XBAR2_OUT_MUX7_CLB5_OUT7               = 0x0E01,
    XBAR2_OUT_MUX8_CLB2_OUT0               = 0x1000,
    XBAR2_OUT_MUX8_CLB6_OUT0               = 0x1001,
    XBAR2_OUT_MUX9_CLB2_OUT1               = 0x1200,
    XBAR2_OUT_MUX9_CLB6_OUT1               = 0x1201,
    XBAR2_OUT_MUX10_CLB2_OUT2              = 0x1400,
    XBAR2_OUT_MUX10_CLB6_OUT2              = 0x1401,
    XBAR2_OUT_MUX11_CLB2_OUT3              = 0x1600,
    XBAR2_OUT_MUX11_CLB6_OUT3              = 0x1601,
    XBAR2_OUT_MUX12_CLB2_OUT4              = 0x1800,
    XBAR2_OUT_MUX12_CLB6_OUT4              = 0x1801,
    XBAR2_OUT_MUX13_CLB2_OUT5              = 0x1A00,
    XBAR2_OUT_MUX13_CLB6_OUT5              = 0x1A01,
    XBAR2_OUT_MUX14_CLB2_OUT6              = 0x1C00,
    XBAR2_OUT_MUX14_CLB6_OUT6              = 0x1C01,
    XBAR2_OUT_MUX15_CLB2_OUT7              = 0x1E00,
    XBAR2_OUT_MUX15_CLB6_OUT7              = 0x1E01,
    XBAR2_OUT_MUX16_CLB3_OUT0              = 0x2000,
    XBAR2_OUT_MUX16_CLB7_OUT0              = 0x2001,
    XBAR2_OUT_MUX17_CLB3_OUT1              = 0x2200,
    XBAR2_OUT_MUX17_CLB7_OUT1              = 0x2201,
    XBAR2_OUT_MUX18_CLB3_OUT2              = 0x2400,
    XBAR2_OUT_MUX18_CLB7_OUT2              = 0x2401,
    XBAR2_OUT_MUX19_CLB3_OUT3              = 0x2600,
    XBAR2_OUT_MUX19_CLB7_OUT3              = 0x2601,
    XBAR2_OUT_MUX20_CLB3_OUT4              = 0x2800,
    XBAR2_OUT_MUX20_CLB7_OUT4              = 0x2801,
    XBAR2_OUT_MUX21_CLB3_OUT5              = 0x2A00,
    XBAR2_OUT_MUX21_CLB7_OUT5              = 0x2A01,
    XBAR2_OUT_MUX22_CLB3_OUT6              = 0x2C00,
    XBAR2_OUT_MUX22_CLB7_OUT6              = 0x2C01,
    XBAR2_OUT_MUX23_CLB3_OUT7              = 0x2E00,
    XBAR2_OUT_MUX23_CLB7_OUT7              = 0x2E01,
    XBAR2_OUT_MUX24_CLB4_OUT0              = 0x3000,
    XBAR2_OUT_MUX24_CLB8_OUT0              = 0x3001,
    XBAR2_OUT_MUX25_CLB4_OUT1              = 0x3200,
    XBAR2_OUT_MUX25_CLB8_OUT1              = 0x3201,
    XBAR2_OUT_MUX26_CLB4_OUT2              = 0x3400,
    XBAR2_OUT_MUX26_CLB8_OUT2              = 0x3401,
    XBAR2_OUT_MUX27_CLB4_OUT3              = 0x3600,
    XBAR2_OUT_MUX27_CLB8_OUT3              = 0x3601,
    XBAR2_OUT_MUX28_CLB4_OUT4              = 0x3800,
    XBAR2_OUT_MUX28_CLB8_OUT4              = 0x3801,
    XBAR2_OUT_MUX29_CLB4_OUT5              = 0x3A00,
    XBAR2_OUT_MUX29_CLB8_OUT5              = 0x3A01,
    XBAR2_OUT_MUX30_CLB4_OUT6              = 0x3C00,
    XBAR2_OUT_MUX30_CLB8_OUT6              = 0x3C01,
    XBAR2_OUT_MUX31_CLB4_OUT7              = 0x3E00,
    XBAR2_OUT_MUX31_CLB8_OUT7              = 0x3E01
...
typedef enum
{
    ...
    XBAR_EPWM_MUX01_CLB1_4_1               = 0x0202,
    ...
    XBAR_EPWM_MUX03_CLB1_5_1               = 0x0602,
    ...
    XBAR_EPWM_MUX05_CLB2_4_1               = 0x0A02,
    ...
    XBAR_EPWM_MUX07_CLB2_5_1               = 0x0E02,
    ...
    XBAR_EPWM_MUX09_CLB3_4_1               = 0x1202,
    ...
    XBAR_EPWM_MUX11_CLB3_5_1               = 0x1602,
    ...
    XBAR_EPWM_MUX17_CLB5_4_1               = 0x2202,
    ...
    XBAR_EPWM_MUX19_CLB5_5_1               = 0x2602,
    ...
    XBAR_EPWM_MUX21_CLB6_4_1               = 0x2A02,
    ...
    XBAR_EPWM_MUX23_CLB6_5_1               = 0x2E02,
    ...
    XBAR_EPWM_MUX25_CLB7_4_1               = 0x3203,
    ...
    XBAR_EPWM_MUX27_CLB7_5_1               = 0x3603,
...
typedef enum
{
    ...
    XBAR_CLB_MUX01_CLB1_4_1                = 0x0202,
    ...
    XBAR_CLB_MUX03_CLB1_5_1                = 0x0602,
    ...
    XBAR_CLB_MUX05_CLB2_4_1                = 0x0A02,
    ...
    XBAR_CLB_MUX07_CLB2_5_1                = 0x0E02,
    ...
    XBAR_CLB_MUX09_CLB3_4_1                = 0x1202,
    ...
    XBAR_CLB_MUX11_CLB3_5_1                = 0x1602,
    ...
    XBAR_CLB_MUX17_CLB5_4_1                = 0x2202,
    ...
    XBAR_CLB_MUX19_CLB5_5_1                = 0x2602,
    ...
    XBAR_CLB_MUX21_CLB6_4_1                = 0x2A02,
    ...
    XBAR_CLB_MUX23_CLB6_5_1                = 0x2E02,
    ...
    XBAR_CLB_MUX25_CLB7_4_1                = 0x3203,
    ...
    XBAR_CLB_MUX27_MCANA_FEVT0             = 0x3602,
    XBAR_CLB_MUX27_CLB7_5_1                = 0x3603,
    ...
    XBAR_CLB_MUX29_MCANA_FEVT0             = 0x3A02,
    XBAR_CLB_MUX29_CLB8_4_1                = 0x3A03,
    ...
    XBAR_CLB_MUX31_CLB8_5_1                = 0x3E03,
...
typedef enum
{
    ...
    XBAR_INPUT_FLG_CLB1_4_1         = 0x0310,
    XBAR_INPUT_FLG_CLB1_5_1         = 0x0311,
    XBAR_INPUT_FLG_CLB2_4_1         = 0x0312,
    XBAR_INPUT_FLG_CLB2_5_1         = 0x0313,
    XBAR_INPUT_FLG_CLB3_4_1         = 0x0314,
    XBAR_INPUT_FLG_CLB3_5_1         = 0x0315,
    XBAR_INPUT_FLG_CLB4_4_1         = 0x0316,
    XBAR_INPUT_FLG_CLB4_5_1         = 0x0317,
    XBAR_INPUT_FLG_CLB5_4_1         = 0x0318,
    XBAR_INPUT_FLG_CLB5_5_1         = 0x0319,
    XBAR_INPUT_FLG_CLB6_4_1         = 0x031A,
    XBAR_INPUT_FLG_CLB6_5_1         = 0x031B,
...
XBAR_isBaseValid(uint32_t base)
{
    ...
    return((base == XBAR_OUTPUT_EN_REG_BASE) ||
           (base == XBAR_OUTPUT_CFG_REG_BASE) ||
           (base == OUTPUTXBAR_BASE) || (base == INPUTXBAR_BASE) ||
           (base == XBAR2_OUTPUT_EN_REG_BASE) ||
           (base == XBAR2_OUTPUT_CFG_REG_BASE) ||
           (base == OUTPUTXBAR2_BASE) || (base == XBAR2_INPUT_BASE) ||
           (base == INPUTXBAR2_BASE) ||
           (base == XBAR_INPUT_BASE) );
...
//! XBAR_OUTPUT_EN_REG_BASE
//! or XBAR2_OUTPUT_EN_REG_BASE.
//!
...
XBAR_setInputPin(uint32_t base, XBAR_InputNum input, uint16_t pin)
{
    ...
    HWREGH(base + (uint16_t)input) = pin;
...
//!
//! The \e base parameter can take base addresses
//! XBAR_OUTPUT_CFG_REG_BASE
//! or XBAR2_OUTPUT_CFG_REG_BASE.
//!
...
//!
//! The values above can be passed for the OUTPUT XBAR .
//! The values for the OUTPUT XBAR2 have the format of
//! \b XBAR2_OUT_MUXnn_xx where the 'xx' is the signal and nn is the mux
//! number (00 through 31).
//!
...
XBAR_invertCLBSignal(XBAR_AuxSigNum auxSignal, bool invert)
{
    ...
    if(invert)
    {
        HWREG(CLBXBAR_BASE + XBAR_O_AUXSIGOUTINV) |=
            (uint32_t)0x1U << ((uint16_t)auxSignal / 2U);
    }
    else
    {
        HWREG(CLBXBAR_BASE + XBAR_O_AUXSIGOUTINV) &=
