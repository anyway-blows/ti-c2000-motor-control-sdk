...
#define ADC_O_CONFIG              0x3EU        // ADC Config Register
...
#define ADC_O_INLTRIMCTL          0x7EU        // ADC Linearity Trim Control
                                               // Register
...
//*****************************************************************************
//
// The following are defines for the bit fields in the ADCINLTRIMCTL register
//
//*****************************************************************************
#define ADC_INLTRIMCTL_CALIBMODE  0x1U         // ADC Linearity Calibration
                                               // Mode
#define ADC_INLTRIMCTL_CALIBSTEP_S  1U
#define ADC_INLTRIMCTL_CALIBSTEP_M  0x3EU        // ADC Linearity Calibration
                                               // Step
#define ADC_INLTRIMCTL_KEY_S      16U
#define ADC_INLTRIMCTL_KEY_M      0xFFFF0000U  // ADC Linearity Trim Control
                                               // Write Key
