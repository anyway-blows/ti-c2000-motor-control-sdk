...
#define DCSM_O_B0_Z2OTP_LINKPOINTER3  0x8U         // Zone 12Link Pointer3 in Z2
                                               // OTP for flash BANK0
#define DCSM_O_Z2OTP_BOOTPIN_CONFIG  0xCU         // Boot Pin Configuration
#define DCSM_O_Z2OTP_GPREG2       0xEU         // Zone-2 General Purpose
                                               // Register-2 content
...
#define DCSM_O_Z2OTP_BOOTDEF_LOW  0x1CU        // Boot definition (low 32bit)
#define DCSM_O_Z2OTP_BOOTDEF_HIGH  0x1EU        // Boot definition (high 32bit)
...
#define DCSM_O_Z1_CSMLOCKSR       0x18U        // Zone 1 CSM Lock Status
                                               // Register
...
#define DCSM_O_Z1_EXEONLYRAMR     0x20U        // Zone 1 RAM Execute_Only Block
                                               // Register
#define DCSM_O_Z1_EXEONLYDIS      0x22U        // Zone1 Execute_Only Disable
                                               // Register
...
#define DCSM_O_Z2_CSMLOCKSR       0x18U        // Zone 2 CSM Lock Status
                                               // Register
...
#define DCSM_O_Z2_EXEONLYRAMR     0x20U        // Zone 2 RAM Execute_Only Block
                                               // Register
#define DCSM_O_Z2_EXEONLYDIS      0x22U        // Zone2 Execute_Only Disable
                                               // Register
...
#define DCSM_O_SECDC              0x6U         // Security Device Capability
                                               // Register
...
//*****************************************************************************
//
// The following are defines for the bit fields in the Z1_CSMLOCKSR register
//
//*****************************************************************************
#define DCSM_Z1_CSMLOCKSR_LOCK0   0x1U         // Password 0 Read Status
#define DCSM_Z1_CSMLOCKSR_LOCK1   0x2U         // Password 1 Read Status
#define DCSM_Z1_CSMLOCKSR_LOCK2   0x4U         // Password 2 Read Status
#define DCSM_Z1_CSMLOCKSR_LOCK3   0x8U         // Password 3 Read Status
...
#define DCSM_Z1_CR_USBD_OPEN      0x80U        // Reflects USBD state of the
                                               // CSM
...
//*****************************************************************************
//
// The following are defines for the bit fields in the Z1_EXEONLYDIS register
//
//*****************************************************************************
#define DCSM_Z1_EXEONLYDIS_DIS    0x1U         // Zone-1 Execute-Only Disable
...
//*****************************************************************************
//
// The following are defines for the bit fields in the Z2_CSMLOCKSR register
//
//*****************************************************************************
#define DCSM_Z2_CSMLOCKSR_LOCK0   0x1U         // Password 0 Read Status
#define DCSM_Z2_CSMLOCKSR_LOCK1   0x2U         // Password 1 Read Status
#define DCSM_Z2_CSMLOCKSR_LOCK2   0x4U         // Password 2 Read Status
#define DCSM_Z2_CSMLOCKSR_LOCK3   0x8U         // Password 3 Read Status
...
#define DCSM_Z2_CR_USBD_OPEN      0x80U        // Reflects USBD state of the
                                               // CSM
...
//*****************************************************************************
//
// The following are defines for the bit fields in the Z2_EXEONLYDIS register
//
//*****************************************************************************
#define DCSM_Z2_EXEONLYDIS_DIS    0x1U         // Zone-2 Execute-Only Disable
...
//*****************************************************************************
//
// The following are defines for the bit fields in the SECDC register
//
//*****************************************************************************
#define DCSM_SECDC_CPUSLDIS       0x1U         // CPU Core Secure Logic Disable
#define DCSM_SECDC_ECSLDIS        0x2U         // ECSL Disable
#define DCSM_SECDC_FASTSPINEN_S   2U
#define DCSM_SECDC_FASTSPINEN_M   0x3CU        // FASTSPIN  Device.
