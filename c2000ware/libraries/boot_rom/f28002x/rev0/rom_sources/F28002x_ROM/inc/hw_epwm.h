...
#define EPWM_O_SYNCINSEL          0x3U         // EPWMxSYNCIN Source Select
                                               // Register
#define EPWM_O_TBCTR              0x4U         // Time Base Counter Register
#define EPWM_O_TBSTS              0x5U         // Time Base Status Register
#define EPWM_O_SYNCOUTEN          0x6U         // EPWMxSYNCOUT Source Enable
                                               // Register
...
#define EPWM_O_VCNTCFG            0x19U        // Valley Counter Config
                                               // Register
#define EPWM_O_HRCAL              0x22U        // HRPWM Calibration Register
#define EPWM_O_HRPRD              0x23U        // HRPWM Period Register
#define EPWM_O_HRCNT0             0x24U        // HRPWM Counter 0 Register
#define EPWM_O_HRCNT1             0x25U        // HRPWM Counter 1 Register
...
#define EPWM_O_HRPWMREV           0x3FU        // High Resolution Revision
                                               // Register
...
#define EPWM_O_TBPRDHRB           0x64U        // Calculation Result for EPWMxB
...
//
//*****************************************************************************
#define EPWM_SYNCOUTEN_SWEN       0x1U         // EPWMxSYNCO Software Force
                                               // Enable
#define EPWM_SYNCOUTEN_ZEROEN     0x2U         // EPWMxSYNCO Zero Count Event
                                               // Enable
#define EPWM_SYNCOUTEN_CMPBEN     0x4U         // EPWMxSYNCO Compare B Event
                                               // Enable
#define EPWM_SYNCOUTEN_CMPCEN     0x8U         // EPWMxSYNCO Compare C Event
                                               // Enable
#define EPWM_SYNCOUTEN_CMPDEN     0x10U        // EPWMxSYNCO Compare D Event
                                               // Enable
#define EPWM_SYNCOUTEN_DCAEVT1EN  0x20U        // EPWMxSYNCO Digital Compare A
                                               // Event 1 Sync Enable
#define EPWM_SYNCOUTEN_DCBEVT1EN  0x40U        // EPWMxSYNCO Digital Compare B
                                               // Event 1 Sync Enable
...
#define EPWM_TBCTL3_RERSERVED_S   1U
#define EPWM_TBCTL3_RERSERVED_M   0xFFFEU      // Reserved
...
//*****************************************************************************
//
// The following are defines for the bit fields in the HRPWMREV register
//
//*****************************************************************************
#define EPWM_HRPWMREV_REV_S       0U
#define EPWM_HRPWMREV_REV_M       0xFFU        // HRPWM Silicon Revision bits
#define EPWM_HRPWMREV_TYPE_S      8U
#define EPWM_HRPWMREV_TYPE_M      0xFF00U      // HRPWM Type Bits
...
#define EPWM_TBPHS_TBPHSHR_M      0xFFFFU      // Extension Register for HRPWM
                                               // Phase (8-bits)
...
//*****************************************************************************
//
// The following are defines for the bit fields in the TBPRDHRB register
//
//*****************************************************************************
#define EPWM_TBPRDHRB_TBPRDHRB_DELAY_S  0U
#define EPWM_TBPRDHRB_TBPRDHRB_DELAY_M  0xFFU        // TBPRDHRB Delay (TI Test)
#define EPWM_TBPRDHRB_TBPRDHRB_S  8U
#define EPWM_TBPRDHRB_TBPRDHRB_M  0xFF00U      // TBPRDHR Calc (2) Results for
                                               // EPWMxB Eqns
...
#define EPWM_CMPA_CMPAHR_M        0xFFFFU      // Compare A HRPWM Extension
                                               // Register
...
#define EPWM_CMPB_CMPBHR_M        0xFFFFU      // Compare B High Resolution
                                               // Bits
...
#define EPWM_DCACTL_EVT1LATCLRSEL_M  0x60U        // DCAEVT1 Latched clear source
                                               // select
#define EPWM_DCACTL_EVT1LAT       0x80U        // Indicates the status of
                                               // DCAEVT1LAT signal.
...
#define EPWM_DCACTL_EVT2LATCLRSEL_M  0x6000U      // DCAEVT2 Latched clear source
                                               // select
#define EPWM_DCACTL_EVT2LAT       0x8000U      // Indicates the status of
                                               // DCAEVT2LAT signal.
...
#define EPWM_DCBCTL_EVT1LATCLRSEL_M  0x60U        // DCBEVT1 Latched clear source
                                               // select
#define EPWM_DCBCTL_EVT1LAT       0x80U        // Indicates the status of
                                               // DCBEVT1LAT signal.
...
#define EPWM_DCBCTL_EVT2LATCLRSEL_M  0x6000U      // DCBEVT2 Latched clear source
                                               // select
#define EPWM_DCBCTL_EVT2LAT       0x8000U      // Indicates the status of
                                               // DCBEVT2LAT signal.
