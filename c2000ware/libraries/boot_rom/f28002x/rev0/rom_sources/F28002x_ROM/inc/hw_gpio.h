...
#define GPIO_O_GPHCTRL            0x1C0U       // GPIO H Qualification Sampling
                                               // Period Control (GPIO224 to
                                               // 255)
#define GPIO_O_GPHQSEL1           0x1C2U       // GPIO H Qualifier Select 1
                                               // Register (GPIO224 to 239)
#define GPIO_O_GPHQSEL2           0x1C4U       // GPIO H Qualifier Select 2
                                               // Register (GPIO240 to 255)
#define GPIO_O_GPHMUX1            0x1C6U       // GPIO H Mux 1 Register
                                               // (GPIO224 to 239)
#define GPIO_O_GPHMUX2            0x1C8U       // GPIO H Mux 2 Register
                                               // (GPIO240 to 255)
#define GPIO_O_GPHPUD             0x1CCU       // GPIO H Pull Up Disable
                                               // Register (GPIO224 to 255)
#define GPIO_O_GPHINV             0x1D0U       // GPIO H Input Polarity Invert
                                               // Registers (GPIO224 to 255)
#define GPIO_O_GPHAMSEL           0x1D4U       // GPIO H Analog Mode Select
                                               // register (GPIO224 to GPIO255)
#define GPIO_O_GPHGMUX1           0x1E0U       // GPIO H Peripheral Group Mux
                                               // (GPIO224 to 239)
#define GPIO_O_GPHGMUX2           0x1E2U       // GPIO H Peripheral Group Mux
                                               // (GPIO240 to 255)
#define GPIO_O_GPHLOCK            0x1FCU       // GPIO H Lock Configuration
                                               // Register (GPIO224 to 255)
...
#define GPIO_O_GPBTOGGLE          0xEU         // GPIO B Data Toggle Register
                                               // (GPIO32 to 63)
#define GPIO_O_GPHDAT             0x38U        // GPIO H Data Register (GPIO224
                                               // to 255)
...
#define GPIO_GPHMUX1_GPIO224_M    0x3U         // Defines pin-muxing selection
                                               // for GPIO224
#define GPIO_GPHMUX1_GPIO225_S    2U
#define GPIO_GPHMUX1_GPIO225_M    0xCU         // Defines pin-muxing selection
                                               // for GPIO225
#define GPIO_GPHMUX1_GPIO226_S    4U
#define GPIO_GPHMUX1_GPIO226_M    0x30U        // Defines pin-muxing selection
                                               // for GPIO226
#define GPIO_GPHMUX1_GPIO227_S    6U
#define GPIO_GPHMUX1_GPIO227_M    0xC0U        // Defines pin-muxing selection
                                               // for GPIO227
#define GPIO_GPHMUX1_GPIO228_S    8U
#define GPIO_GPHMUX1_GPIO228_M    0x300U       // Defines pin-muxing selection
                                               // for GPIO228
#define GPIO_GPHMUX1_GPIO230_S    12U
#define GPIO_GPHMUX1_GPIO230_M    0x3000U      // Defines pin-muxing selection
                                               // for GPIO230
#define GPIO_GPHMUX1_GPIO231_S    14U
#define GPIO_GPHMUX1_GPIO231_M    0xC000U      // Defines pin-muxing selection
                                               // for GPIO231
#define GPIO_GPHMUX1_GPIO232_S    16U
#define GPIO_GPHMUX1_GPIO232_M    0x30000U     // Defines pin-muxing selection
                                               // for GPIO232
#define GPIO_GPHMUX1_GPIO233_S    18U
#define GPIO_GPHMUX1_GPIO233_M    0xC0000U     // Defines pin-muxing selection
                                               // for GPIO233
#define GPIO_GPHMUX1_GPIO237_S    26U
#define GPIO_GPHMUX1_GPIO237_M    0xC000000U   // Defines pin-muxing selection
                                               // for GPIO237
#define GPIO_GPHMUX1_GPIO238_S    28U
#define GPIO_GPHMUX1_GPIO238_M    0x30000000U  // Defines pin-muxing selection
                                               // for GPIO238
#define GPIO_GPHMUX1_GPIO239_S    30U
#define GPIO_GPHMUX1_GPIO239_M    0xC0000000U  // Defines pin-muxing selection
                                               // for GPIO239
...
#define GPIO_GPHMUX2_GPIO241_M    0xCU         // Defines pin-muxing selection
                                               // for GPIO241
#define GPIO_GPHMUX2_GPIO242_S    4U
#define GPIO_GPHMUX2_GPIO242_M    0x30U        // Defines pin-muxing selection
                                               // for GPIO242
#define GPIO_GPHMUX2_GPIO244_S    8U
#define GPIO_GPHMUX2_GPIO244_M    0x300U       // Defines pin-muxing selection
                                               // for GPIO244
#define GPIO_GPHMUX2_GPIO245_S    10U
#define GPIO_GPHMUX2_GPIO245_M    0xC00U       // Defines pin-muxing selection
                                               // for GPIO245
...
#define GPIO_GPHGMUX1_GPIO224_M   0x3U         // Defines pin-muxing selection
                                               // for GPIO224
#define GPIO_GPHGMUX1_GPIO225_S   2U
#define GPIO_GPHGMUX1_GPIO225_M   0xCU         // Defines pin-muxing selection
                                               // for GPIO225
#define GPIO_GPHGMUX1_GPIO226_S   4U
#define GPIO_GPHGMUX1_GPIO226_M   0x30U        // Defines pin-muxing selection
                                               // for GPIO226
#define GPIO_GPHGMUX1_GPIO227_S   6U
#define GPIO_GPHGMUX1_GPIO227_M   0xC0U        // Defines pin-muxing selection
                                               // for GPIO227
#define GPIO_GPHGMUX1_GPIO228_S   8U
#define GPIO_GPHGMUX1_GPIO228_M   0x300U       // Defines pin-muxing selection
                                               // for GPIO228
#define GPIO_GPHGMUX1_GPIO230_S   12U
#define GPIO_GPHGMUX1_GPIO230_M   0x3000U      // Defines pin-muxing selection
                                               // for GPIO230
#define GPIO_GPHGMUX1_GPIO231_S   14U
#define GPIO_GPHGMUX1_GPIO231_M   0xC000U      // Defines pin-muxing selection
                                               // for GPIO231
#define GPIO_GPHGMUX1_GPIO232_S   16U
#define GPIO_GPHGMUX1_GPIO232_M   0x30000U     // Defines pin-muxing selection
                                               // for GPIO232
#define GPIO_GPHGMUX1_GPIO233_S   18U
#define GPIO_GPHGMUX1_GPIO233_M   0xC0000U     // Defines pin-muxing selection
                                               // for GPIO233
#define GPIO_GPHGMUX1_GPIO237_S   26U
#define GPIO_GPHGMUX1_GPIO237_M   0xC000000U   // Defines pin-muxing selection
                                               // for GPIO237
#define GPIO_GPHGMUX1_GPIO238_S   28U
#define GPIO_GPHGMUX1_GPIO238_M   0x30000000U  // Defines pin-muxing selection
                                               // for GPIO238
#define GPIO_GPHGMUX1_GPIO239_S   30U
#define GPIO_GPHGMUX1_GPIO239_M   0xC0000000U  // Defines pin-muxing selection
                                               // for GPIO239
...
#define GPIO_GPHGMUX2_GPIO241_M   0xCU         // Defines pin-muxing selection
                                               // for GPIO241
#define GPIO_GPHGMUX2_GPIO242_S   4U
#define GPIO_GPHGMUX2_GPIO242_M   0x30U        // Defines pin-muxing selection
                                               // for GPIO242
#define GPIO_GPHGMUX2_GPIO244_S   8U
#define GPIO_GPHGMUX2_GPIO244_M   0x300U       // Defines pin-muxing selection
                                               // for GPIO244
#define GPIO_GPHGMUX2_GPIO245_S   10U
#define GPIO_GPHGMUX2_GPIO245_M   0xC00U       // Defines pin-muxing selection
                                               // for GPIO245
