...
#define HIC_O_HOSTCR              0xCU         // HIC Host Control Register
...
#define HIC_O_DBADDR0             0x14U        // Device Base Address Register
                                               // 0
#define HIC_O_DBADDR1             0x16U        // Device Base Address Register
                                               // 1
#define HIC_O_DBADDR2             0x18U        // Device Base Address Register
                                               // 2
#define HIC_O_DBADDR3             0x1AU        // Device Base Address Register
                                               // 3
#define HIC_O_DBADDR4             0x1CU        // Device Base Address Register
                                               // 4
#define HIC_O_DBADDR5             0x1EU        // Device Base Address Register
                                               // 5
#define HIC_O_DBADDR6             0x20U        // Device Base Address Register
                                               // 6
#define HIC_O_DBADDR7             0x22U        // Device Base Address Register
                                               // 7
...
#define HIC_MODECR_H2DBUF_DEVWREN  0x100U       // Write Enable for Device to
                                               // H2D Buffer
#define HIC_MODECR_D2HBUF_HOSTWREN  0x200U       // Write Enable for Host to D2H
                                               // Buffer
#define HIC_MODECR_EN_DEVACC      0x400U       // Enable Host access to Device
                                               // region
#define HIC_MODECR_EN_HOSTWREALLOW  0x800U       // Enable Host Write to
                                               // EALLOWCTL register
...
#define HIC_ERRADDR_H2D_ERR_ADDR_M  0xFFU        // Address of the Host bus
                                               // captured upon an error for Device
#define HIC_ERRADDR_H2D_BASE_SEL_S  12U
#define HIC_ERRADDR_H2D_BASE_SEL_M  0x7000U      // Base Select corresponding to
                                               // H2D error event
#define HIC_ERRADDR_D2H_ERR_ADDR_S  16U
#define HIC_ERRADDR_D2H_ERR_ADDR_M  0xFF0000U    // Address of the Host bus
                                               // captured upon an error for Host
#define HIC_ERRADDR_D2H_BASE_SEL_S  28U
#define HIC_ERRADDR_D2H_BASE_SEL_M  0x70000000U  // Base Select corresponding to
                                               // D2H error event
...
//
//*****************************************************************************
#define HIC_H2DINTEN_H2D_INTEN    0x1U         // Host To Device Interrupt
                                               // Enable
#define HIC_H2DINTEN_BUSERR_INTEN  0x2U         // BusError Interrupt Enable
#define HIC_H2DINTEN_ILLWR_INTEN  0x4U         // Illegal Write event interrupt
                                               // enable
#define HIC_H2DINTEN_ILLRD_INTEN  0x8U         // Illegal Read event interrupt
                                               // enable
...
#define HIC_H2DINTFLG_ILLWR_FLG   0x4U         // Illegal write event interrupt
                                               // flag
#define HIC_H2DINTFLG_ILLRD_FLG   0x8U         // Illegal read event interrupt
                                               // flag
...
//
//*****************************************************************************
#define HIC_H2DINTCLR_H2D_CLR     0x1U         // Host To Device Interrupt
                                               // Clear
...
#define HIC_H2DINTFRC_ILLWR_INTFRC  0x4U         // Illegal Write Interrupt Force
                                               // Set
#define HIC_H2DINTFRC_ILLRD_INTFRC  0x8U         // Illegal Read Interrupt Force
                                               // Set
...
//
//*****************************************************************************
#define HIC_D2HINTEN_D2H_INTEN    0x1U         // Device to Host Data Ready
                                               // Interrupt Enable
#define HIC_D2HINTEN_BUSERR_INTEN  0x2U         // BusError Interrupt Enable
#define HIC_D2HINTEN_ILLWR_INTEN  0x4U         // Illegal Write event Interrupt
                                               // Enable
#define HIC_D2HINTEN_ILLRD_INTEN  0x8U         // Illegal Read event Interrupt
                                               // Enable
#define HIC_D2HINTEN_ACCVIO_INTEN  0x10U        // Access Violation Interrupt
                                               // Enable
#define HIC_D2HINTEN_EVTRIG_INTEN_S  16U
#define HIC_D2HINTEN_EVTRIG_INTEN_M  0xFFFF0000U  // Event Trigger Interrupt
                                               // Enable
...
//
//*****************************************************************************
#define HIC_D2HINTCLR_D2H_CLR     0x1U         // Device to Host Interrupt
                                               // Clear
...
#define HIC_D2HINTCLR_ACCVIO_CLR  0x10U        // Access Violation Interrupt
                                               // Clear
...
#define HIC_D2HINTFRC_ILLWR_INTFRC  0x4U         // Illegal Write Interrupt Force
                                               // Set
#define HIC_D2HINTFRC_ILLRD_INTFRC  0x8U         // Illegal Read Interrupt Force
                                               // Set
#define HIC_D2HINTFRC_ACCVIO_INTFRC  0x10U        // Access Violation Interrupt
                                               // Force Set
#define HIC_D2HINTFRC_EVTRIG_INTFRC_S  16U
#define HIC_D2HINTFRC_EVTRIG_INTFRC_M  0xFFFF0000U  // Event Trigger Interrupt Force
                                               // Set
#endif
