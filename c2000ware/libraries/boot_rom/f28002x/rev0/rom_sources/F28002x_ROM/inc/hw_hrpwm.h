...
#define HRPWM_O_HRCAL             0x22U        // HRPWM Calibration Register
#define HRPWM_O_HRPRD             0x23U        // HRPWM Period Register
#define HRPWM_O_HRCNT0            0x24U        // HRPWM Counter 0 Register
#define HRPWM_O_HRCNT1            0x25U        // HRPWM Counter 1 Register
...
#define HRPWM_O_REV               0x3FU        // High Resolution Revision
                                               // Register
...
#define HRPWM_O_TBPRDHRB          0x64U        // Calculation Result for EPWMxB
...
#define HRPWM_HRCNFG_HRLOADB_M    0x1800U      // ePWMxB Shadow Mode Select
                                               // Bits
#define HRPWM_HRCNFG_LINESEL_S    14U
#define HRPWM_HRCNFG_LINESEL_M    0xC000U      // Delay Line Selection bits
...
//
//*****************************************************************************
#define HRPWM_HRPWR_CALSTART      0x4U         // Calibration Start/Stop
#define HRPWM_HRPWR_CNTSEL        0x8U         // Counter Select Bit
#define HRPWM_HRPWR_CALSTS        0x10U        // Calibration Status Bit
#define HRPWM_HRPWR_TESTSEL       0x20U        // Test Mode (Lump Delay) Select
                                               // Bit
#define HRPWM_HRPWR_CALSEL_S      6U
#define HRPWM_HRPWR_CALSEL_M      0x3C0U       // ePWM Delay Line Selection for
                                               // Calibration
...
//
//*****************************************************************************
#define HRPWM_HRCAL_HRCAL_S       0U
#define HRPWM_HRCAL_HRCAL_M       0xFFU        // Delay Line Calibration Value
                                               // Register.
...
#define HRPWM_HRCNFG2_CTLMODEDBFED_M  0x30U        // DBFED Control Mode Select
                                               // Bits
#define HRPWM_HRCNFG2_DELLOADFRC  0x4000U      // Delay Line Load Software
                                               // Force
#define HRPWM_HRCNFG2_NOBYPASS    0x8000U      // No Bypass Delay Line Update
...
#define HRPWM_HRPCTL_HRPSYNCE     0x8U         // High Resolution Period Sync
                                               // Enable
...
//
//*****************************************************************************
#define HRPWM_REV_REV_S           0U
#define HRPWM_REV_REV_M           0xFFU        // HRPWM Silicon Revision bits
#define HRPWM_REV_TYPE_S          8U
#define HRPWM_REV_TYPE_M          0xFF00U      // HRPWM Type Bits
...
//
//*****************************************************************************
#define HRPWM_DBREDHR_DBREDHR_DELAY_S  1U
#define HRPWM_DBREDHR_DBREDHR_DELAY_M  0xFEU        // DBREDHR Delay (TI Test)
...
//
//*****************************************************************************
#define HRPWM_DBFEDHR_DBFEDHR_DELAY_S  1U
#define HRPWM_DBFEDHR_DBFEDHR_DELAY_M  0xFEU        // DBFEDHR Delay (TI Test)
...
//
//*****************************************************************************
#define HRPWM_TBPRDHRB_TBPRDHRB_DELAY_S  0U
#define HRPWM_TBPRDHRB_TBPRDHRB_DELAY_M  0xFFU        // TBPRDHRB Delay (TI Test)
#define HRPWM_TBPRDHRB_TBPRDHRB_S  8U
#define HRPWM_TBPRDHRB_TBPRDHRB_M  0xFF00U      // TBPRDHR Calc (2) Results for
                                               // EPWMxB Eqns
