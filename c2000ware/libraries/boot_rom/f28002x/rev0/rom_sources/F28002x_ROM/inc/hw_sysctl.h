...
#define SYSCTL_O_DC1              0x12U        // Device Capability: Processing
                                               // Block Customization
#define SYSCTL_O_DC3              0x16U        // Device Capability: ETPWM
#define SYSCTL_O_DC4              0x18U        // Device Capability: ECAP
#define SYSCTL_O_DC5              0x1AU        // Device Capability: EQEP
#define SYSCTL_O_DC8              0x20U        // Device Capability: SCI
#define SYSCTL_O_DC9              0x22U        // Device Capability: SPI
#define SYSCTL_O_DC10             0x24U        // Device Capability: I2C
#define SYSCTL_O_DC11             0x26U        // Device Capability: CAN
#define SYSCTL_O_DC14             0x2CU        // Device Capability: ADC
#define SYSCTL_O_DC15             0x2EU        // Device Capability: CMPSS
...
#define SYSCTL_O_DC27             0x46U        // Device Capability: BGCRC
#define SYSCTL_O_DC28             0x48U        // Device Capability: HIC
...
#define SYSCTL_O_SOFTPRES21       0xACU        // Peripheral Software Reset
                                               // register
#define SYSCTL_O_SOFTPRES22       0xAEU        // Peripheral Software Reset
                                               // register
#define SYSCTL_O_SOFTPRES25       0xB4U        // Peripheral Software Reset
                                               // register
#define SYSCTL_O_SOFTPRES40       0xD2U        // Peripheral Software Reset
                                               // register
#define SYSCTL_O_PKGTYPE          0x12EU       // Package type info. for
                                               // internal connections/programming
#define SYSCTL_O_TAP_STATUS       0x130U       // Status of JTAG State machine
                                               // & Debugger Connect
#define SYSCTL_O_CPUROM_DC1       0x140U       // Device Capabiity registers
                                               // for ROM
#define SYSCTL_O_CPUROM_DC2       0x142U       // Device Capabiity registers
                                               // for ROM
#define SYSCTL_O_CPUROM_DC3       0x144U       // Device Capabiity registers
                                               // for ROM
#define SYSCTL_O_CPUROM_DC4       0x146U       // Device Capabiity registers
                                               // for ROM
...
#define SYSCTL_O_XTALCR2          0x3AU        // XTAL Control Register for pad
                                               // init
#define SYSCTL_O_CLKFAILCFG       0x3CU        // Clock Fail cause
                                               // Configuration
...
#define SYSCTL_O_PCLKCR22         0x4EU        // Peripheral Clock Gating
                                               // Register - PBIST
#define SYSCTL_O_PCLKCR25         0x54U        // Peripheral Clock Gating
                                               // Register - HIC
...
#define SYSCTL_O_HRPWM_A_AC       0x1AAU       // HRPWM Master Access Control
                                               // Register
#define SYSCTL_O_HIC_A_AC         0x1ACU       // HIC Master Access Control
                                               // Register
...
//
//*****************************************************************************
#define SYSCTL_DEVCFGLOCK2_DC_PERCNF_PARTID  0x1U         // Lock for DC Periph Conf and
                                               // Partid
...
#define SYSCTL_PARTIDL_CUSTOM_ID1  0x800U       // Custom ID1
#define SYSCTL_PARTIDL_CUSTOM_ID2  0x1000U      // Custom ID2
...
//
//*****************************************************************************
#define SYSCTL_DC4_ECAP1          0x1U         // ECAP1  Present
#define SYSCTL_DC4_ECAP2          0x2U         // ECAP2  Present
#define SYSCTL_DC4_ECAP3          0x4U         // ECAP3  Present
...
//
//*****************************************************************************
#define SYSCTL_DC5_EQEP1          0x1U         // EQEP1  Present
#define SYSCTL_DC5_EQEP2          0x2U         // EQEP2  Present
...
//
//*****************************************************************************
#define SYSCTL_DC8_SCI_A          0x1U         // SCI_A  Present
...
//
//*****************************************************************************
#define SYSCTL_DC9_SPI_A          0x1U         // SPI_A  Present
#define SYSCTL_DC9_SPI_B          0x2U         // SPI_B  Present
...
//
//*****************************************************************************
#define SYSCTL_DC10_I2C_A         0x1U         // I2C_A  Present
#define SYSCTL_DC10_I2C_B         0x2U         // I2C_B  Present
...
//
//*****************************************************************************
#define SYSCTL_DC11_CAN_A         0x1U         // CAN_A  Present
...
//
//*****************************************************************************
#define SYSCTL_DC14_ADC_A         0x1U         // ADC_A Present
#define SYSCTL_DC14_ADC_C         0x4U         // ADC_C Present
...
//
//*****************************************************************************
#define SYSCTL_DC15_CMPSS1        0x1U         // CMPSS1  Present
#define SYSCTL_DC15_CMPSS2        0x2U         // CMPSS2  Present
#define SYSCTL_DC15_CMPSS3        0x4U         // CMPSS3  Present
#define SYSCTL_DC15_CMPSS4        0x8U         // CMPSS4  Present
...
//
//*****************************************************************************
#define SYSCTL_DC18_LS4_1         0x10U        // LS4_1  Present
#define SYSCTL_DC18_LS5_1         0x20U        // LS5_1  Present
#define SYSCTL_DC18_LS6_1         0x40U        // LS6_1 Present
#define SYSCTL_DC18_LS7_1         0x80U        // LS7_1 Present
...
//
//*****************************************************************************
#define SYSCTL_DC20_GS0           0x1U         // GS0  Present
...
//
//*****************************************************************************
#define SYSCTL_DC22_FSITX_A       0x1U         // FSITX_A  Present
#define SYSCTL_DC22_FSIRX_A       0x2U         // FSIRX_A Present
...
//
//*****************************************************************************
#define SYSCTL_DC23_LIN_A         0x1U         // LIN_A  Present
#define SYSCTL_DC23_LIN_B         0x2U         // LIN_B Present
...
//
//*****************************************************************************
#define SYSCTL_DC24_PMBUS_A       0x1U         // PMBUS_A  Present
...
//
//*****************************************************************************
#define SYSCTL_DC25_DCC0          0x1U         // DCC_A  Present
#define SYSCTL_DC25_DCC1          0x2U         // DCC_B  Present
...
//
//*****************************************************************************
#define SYSCTL_DC27_CPU1BGCRC     0x1U         // CPU1BGCRC Present

//*****************************************************************************
//
// The following are defines for the bit fields in the DC28 register
//
//*****************************************************************************
#define SYSCTL_DC28_HIC_A         0x1U         // HIC_A Present
...
//*****************************************************************************
//
// The following are defines for the bit fields in the SOFTPRES22 register
//
//*****************************************************************************
#define SYSCTL_SOFTPRES22_PBIST_0  0x1U         // PBIST Module reset bit
...
//
//*****************************************************************************
#define SYSCTL_SOFTPRES25_HIC_A   0x1U         // HIC Slave & Host controller
                                               // Reset Bit
...
//*****************************************************************************
//
// The following are defines for the bit fields in the PKGTYPE register
//
//*****************************************************************************
#define SYSCTL_PKGTYPE_PKGTYPE_S  0U
#define SYSCTL_PKGTYPE_PKGTYPE_M  0xFU         // Package and Bond Type
                                               // Qualifier
#define SYSCTL_PKGTYPE_BROM_KEY_S  24U
#define SYSCTL_PKGTYPE_BROM_KEY_M  0xFF000000U  // Reserved - Boot ROM OTP Key
                                               // for valid PKGTYPE
...
//*****************************************************************************
//
// The following are defines for the bit fields in the CPUROM_DC1 register
//
//*****************************************************************************
#define SYSCTL_CPUROM_DC1_ROM_DIS_START_ADDR_S  0U
#define SYSCTL_CPUROM_DC1_ROM_DIS_START_ADDR_M  0x1FFU       // Start Address of  disabled
                                               // ROM
#define SYSCTL_CPUROM_DC1_ROM_DIS_SIZE_INV_S  9U
#define SYSCTL_CPUROM_DC1_ROM_DIS_SIZE_INV_M  0xFE00U      // Size(Inverted) of ROM section
                                               // disabled

//*****************************************************************************
//
// The following are defines for the bit fields in the CPUROM_DC2 register
//
//*****************************************************************************
#define SYSCTL_CPUROM_DC2_ROM_DIS_START_ADDR_S  0U
#define SYSCTL_CPUROM_DC2_ROM_DIS_START_ADDR_M  0x1FFU       // Start Address of  disabled
                                               // ROM
#define SYSCTL_CPUROM_DC2_ROM_DIS_SIZE_INV_S  9U
#define SYSCTL_CPUROM_DC2_ROM_DIS_SIZE_INV_M  0xFE00U      // Size(Inverted) of ROM section
                                               // disabled

//*****************************************************************************
//
// The following are defines for the bit fields in the CPUROM_DC3 register
//
//*****************************************************************************
#define SYSCTL_CPUROM_DC3_ROM_DIS_START_ADDR_S  0U
#define SYSCTL_CPUROM_DC3_ROM_DIS_START_ADDR_M  0x1FFU       // Start Address of  disabled
                                               // ROM
#define SYSCTL_CPUROM_DC3_ROM_DIS_SIZE_INV_S  9U
#define SYSCTL_CPUROM_DC3_ROM_DIS_SIZE_INV_M  0xFE00U      // Size(Inverted) of ROM section
                                               // disabled

//*****************************************************************************
//
// The following are defines for the bit fields in the CPUROM_DC4 register
//
//*****************************************************************************
#define SYSCTL_CPUROM_DC4_ROM_DIS_START_ADDR_S  0U
#define SYSCTL_CPUROM_DC4_ROM_DIS_START_ADDR_M  0x1FFU       // Start Address of  disabled
                                               // ROM
#define SYSCTL_CPUROM_DC4_ROM_DIS_SIZE_INV_S  9U
#define SYSCTL_CPUROM_DC4_ROM_DIS_SIZE_INV_M  0xFE00U      // Size(Inverted) of ROM section
                                               // disabled
...
#define SYSCTL_SYSPLLCTL1_VCO_PWDN  0x4U         // Initiate the APLL power down
                                               // sequence enable.
#define SYSCTL_SYSPLLCTL1_AVG_SLIP_FLTR_EN  0x8U         // Enables generation of
                                               // quasi-slip signal from APLL.
#define SYSCTL_SYSPLLCTL1_REF_LOST_EN  0x10U        // Enable Reference-Lost
...
#define SYSCTL_SYSPLLMULT_IMULTEXT_S  12U
#define SYSCTL_SYSPLLMULT_IMULTEXT_M  0x3000U      // SYSPLL Integer Multiplier
                                               // extention
...
#define SYSCTL_SYSPLLSTS_QSLIPS   0x4U         // SYSPLL Quasi Slip Status Bit
#define SYSCTL_SYSPLLSTS_REF_LOSTS  0x8U         // SYSPLL "Reference  Lost"
                                               // Status Bit
...
#define SYSCTL_SYSCLKDIVSEL_PLLSYSCLKDIV_LSB  0x100U       // This bit allows the odd
                                               // division for the sys clock divider
...
//
//*****************************************************************************
#define SYSCTL_XTALCR2_XIF        0x1U         // XI Initial value deposited
                                               // before XOSC start
#define SYSCTL_XTALCR2_XOF        0x2U         // XO Initial value deposited
                                               // before XOSC start
#define SYSCTL_XTALCR2_FEN        0x4U         // XOSC pads initialisation
                                               // enable
...
//
//*****************************************************************************
#define SYSCTL_CLKFAILCFG_DCC0_ERROR_EN  0x1U         // DCC0 Error causes Clock fail
                                               // NMI, ERROR
#define SYSCTL_CLKFAILCFG_DCC1_ERROR_EN  0x2U         // DCC1 Error causes Clock fail
                                               // NMI, ERROR
...
//
//*****************************************************************************
#define SYSCTL_CPUSYSLOCK2_PCLKCR25  0x2U         // Lock bit for PCLKCR25
                                               // Register
...
//
//*****************************************************************************
#define SYSCTL_PCLKCR25_HICA_CLK  0x1U         // HICA Clock Enable Bit
...
#define SYSCTL_ADCA_AC_DMA1_ACC_M  0x30U        // DMA1 Access Conditions to
                                               // Peripheral
#define SYSCTL_ADCA_AC_HICA_ACC_S  6U
#define SYSCTL_ADCA_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_ADCC_AC_DMA1_ACC_M  0x30U        // DMA1 Access Conditions to
                                               // Peripheral
#define SYSCTL_ADCC_AC_HICA_ACC_S  6U
#define SYSCTL_ADCC_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_CMPSS1_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_CMPSS2_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_CMPSS3_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_CMPSS4_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EPWM1_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EPWM2_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EPWM3_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EPWM4_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EPWM5_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EPWM6_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EPWM7_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EQEP1_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_EQEP2_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_ECAP1_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_ECAP2_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_ECAP3_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_CLB1_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_CLB2_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_SCIA_AC_CPU1_ACC_M  0x3U         // CPU1 Access conditions to
                                               // peripheral
#define SYSCTL_SCIA_AC_HICA_ACC_S  6U
#define SYSCTL_SCIA_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_SPIA_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_SPIB_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_I2CA_AC_CPU1_ACC_M  0x3U         // CPU1 Access conditions to
                                               // peripheral
#define SYSCTL_I2CA_AC_HICA_ACC_S  6U
#define SYSCTL_I2CA_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_I2CB_AC_CPU1_ACC_M  0x3U         // CPU1 Access conditions to
                                               // peripheral
#define SYSCTL_I2CB_AC_HICA_ACC_S  6U
#define SYSCTL_I2CB_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_PMBUS_A_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_LIN_A_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_LIN_B_AC_CPU1_ACC_M  0x3U         // CPU1 Access conditions to
                                               // peripheral
#define SYSCTL_LIN_B_AC_DMA1_ACC_S  4U
#define SYSCTL_LIN_B_AC_DMA1_ACC_M  0x30U        // DMA1 Access Conditions to
                                               // Peripheral
#define SYSCTL_LIN_B_AC_HICA_ACC_S  6U
#define SYSCTL_LIN_B_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_DCANA_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_FSIATX_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_FSIARX_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_HRPWM_A_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_HIC_A_AC_CPU1_ACC_M  0x3U         // CPU1 Access conditions to
                                               // peripheral
#define SYSCTL_HIC_A_AC_HICA_ACC_S  6U
#define SYSCTL_HIC_A_AC_HICA_ACC_M  0xC0U        // HICA Access Contions to
                                               // Peripheral
...
#define SYSCTL_VMTSEL_KEY_M       0xFFFF0000U  // KEY to update the VMT Select
...
#define SYSCTL_ECAPTESTMUX0_ECAP1TESTMUXSEL_M  0x1FU        // Mux Select for ECAP1 capture
                                               // event for APLL debug
#define SYSCTL_ECAPTESTMUX0_ECAP2TESTMUXSEL_S  5U
#define SYSCTL_ECAPTESTMUX0_ECAP2TESTMUXSEL_M  0x3E0U       // Mux Select for ECAP2 capture
                                               // event for APLL debug
#define SYSCTL_ECAPTESTMUX0_ECAP3TESTMUXSEL_S  10U
#define SYSCTL_ECAPTESTMUX0_ECAP3TESTMUXSEL_M  0x7C00U      // Mux Select for ECAP3 capture
                                               // event for APLL debug
#define SYSCTL_ECAPTESTMUX0_KEY_S  16U
#define SYSCTL_ECAPTESTMUX0_KEY_M  0xFFFF0000U  // KEY to update the ECAP Test
                                               // mux 0 select
