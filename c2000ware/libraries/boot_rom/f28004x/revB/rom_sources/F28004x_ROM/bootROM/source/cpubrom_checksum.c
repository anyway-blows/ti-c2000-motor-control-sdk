...
const composite_checksum_t pbist_csum_rom = {
		0x00036CA4,	//total_ones
		0x0000629B, 0x000016C0, 00000000,	//bit_column_cksum[0][3];
		0x00006E7D, 0x00001CB8, 00000000,	//bit_column_cksum[1][3];
		0x000005EC, 0x00001B19, 00000000,	//bit_column_cksum[2][3];
		0x0000E790, 0x000018CF, 00000000,	//bit_column_cksum[3][3];
		0x0000886D, 0x0000166C, 00000000,	//bit_column_cksum[4][3];
		0x00005346, 0x00001660, 00000000,	//bit_column_cksum[5][3];
		0x00006331, 0x00001686, 00000000,	//bit_column_cksum[6][3];
		0x0000B608, 0x0000174A, 00000000,	//bit_column_cksum[7][3];
		0x00000000, 0x00000006, 0x00000FED, 0x0000C77D,//row_weight_sum
		0x00000000, 0x00001C5D, 0x00005AE2, 0x000097A4	//fact_weight_sum
};

#pragma DATA_SECTION(csum_rom, ".CKSUMLOC");
const composite_checksum_t csum_rom = {
		0x00131644,	//total_ones
		0x0000B434, 0x000057E1, 0x00000002,	//bit_column_cksum[0][3];
		0x0000DAE1, 0x00009CFF, 0x00000002,	//bit_column_cksum[1][3];
		0x0000638C, 0x00009F7C, 0x00000002,	//bit_column_cksum[2][3];
		0x000019FC, 0x00005EDB, 0x00000002,	//bit_column_cksum[3][3];
		0x00006F33, 0x00007778, 0x00000002,	//bit_column_cksum[4][3];
		0x00005D5B, 0x0000C3DB, 0x00000002,	//bit_column_cksum[5][3];
		0x0000D35E, 0x00008167, 0x00000002,	//bit_column_cksum[6][3];
		0x00003C8D, 0x000064C7, 0x00000002,	//bit_column_cksum[7][3];
		0x00000000, 0x000000A0, 0x0000A589, 0x00001D00,//row_weight_sum
		0x00000000, 0x0000A526, 0x0000A412, 0x00005890	//fact_weight_sum
};
...
unsigned short verify_pbist_checksum_onROM()
{
	...
	mblock_rom[2].firstAddr = 0x003feb22;  //flash api
