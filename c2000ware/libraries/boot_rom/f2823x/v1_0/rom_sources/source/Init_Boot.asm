...
;; Checkin $Date: June 19, 2007   15:51:34 $
;;###########################################################################
;;
;; FILE:    Init_Boot.asm
;;
...
;;###########################################################################
    ...
    .sect ".Version"
    .word 0x0001     ; 2833x Boot ROM Version 1
    .word 0x0607     ; Month/Year: (6/07 = May 2007)

    .sect ".Checksum"; 64-bit Checksum
    .long 0x4B07F9F1 ; least significant 32-bits
    .long 0x000008EA ; most significant 32-bits
