...
;; Checkin $Date: June 3, 2008   13:14:27 $
;;###########################################################################
;;
;; FILE:    Init_Boot.asm
;;
...
;;###########################################################################
    ...
    .sect ".Version"
    .word 0x0B01     ; 2834x Boot ROM Version 1B
    .word 0x0608     ; Month/Year: (6/08 = June 2008)

    .sect ".Checksum"; 64-bit Checksum
    .long 0x8D717B84 ; least significant 32-bits
    .long 0x000008BC ; most significant 32-bits
