...
const composite_checksum_t boot_csum_rom = {
        0x000056BAUL,    //total_ones
        0x000082F6UL, 0x00000053UL, 0x00000000UL,    //bit_column_cksum[0][3];
        0x000095ABUL, 0x0000004EUL, 0x00000000UL,    //bit_column_cksum[1][3];
        0x0000BBA4UL, 0x00000045UL, 0x00000000UL,    //bit_column_cksum[2][3];
        0x0000E70DUL, 0x0000005AUL, 0x00000000UL,    //bit_column_cksum[3][3];
        ...
        0x00000000UL, 0x00000000UL, 0x00001691UL, 0x00002335UL, //row_weight_sum
        0x00000000UL, 0x00000029UL, 0x000080E2UL, 0x0000BA2AUL  //fact_weight_sum
};
...
const composite_checksum_t composite_checksum_in_rom = {
		0x000AACC7UL,	//total_ones
		0x0000DCB7UL, 0x00007FA0UL, 0x00000000UL,	//bit_column_cksum[0][3];
		0x00006C64UL, 0x00007EB1UL, 0x00000000UL,	//bit_column_cksum[1][3];
		0x0000A3D1UL, 0x00007EF2UL, 0x00000000UL,	//bit_column_cksum[2][3];
		0x00008F23UL, 0x0000809DUL, 0x00000000UL,	//bit_column_cksum[3][3];
		0x0000D569UL, 0x00008270UL, 0x00000000UL,	//bit_column_cksum[4][3];
		0x0000F708UL, 0x0000819CUL, 0x00000000UL,	//bit_column_cksum[5][3];
		0x0000BC9DUL, 0x00008147UL, 0x00000000UL,	//bit_column_cksum[6][3];
		0x0000B757UL, 0x000081DAUL, 0x00000000UL,	//bit_column_cksum[7][3];
		0x00000000UL, 0x00000020UL, 0x00002866UL,0x00000AE0UL,   //row_weight_sum
		0x00000000UL, 0x00000C93UL, 0x0000EA81UL,0x0000BBEAUL  	//fact_weight_sum
};
