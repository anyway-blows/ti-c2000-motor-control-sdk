...
{
    //
    // Note: Parameter "bootMode" is unused in this function
    //       but is left as part of the USB_Boot() to maintain
...
//*****************************************************************************
//
// Receive the data from USB buffer
//
// Parameters: None
//
// This function waits for the USB to fill its receive buffer, then reads
// the receive buffer, and acknowledges the end-of-packet
//
// Return: Returns the pointer to the USB receive buffer data
//
//*****************************************************************************
uint16_t USB_GetWordData(void)
{
