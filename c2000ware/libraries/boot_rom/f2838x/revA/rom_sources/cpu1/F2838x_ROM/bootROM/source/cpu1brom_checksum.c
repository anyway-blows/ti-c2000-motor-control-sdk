...
const composite_checksum_t pbist_csum_rom = {
        0x0004B697UL,    //total_ones
        0x0000361BUL, 0x00002A4AUL, 0x00000000UL,    //bit_column_cksum[0][3];
        0x00009D42UL, 0x00003379UL, 0x00000000UL,    //bit_column_cksum[1][3];
        0x0000AC8AUL, 0x0000313BUL, 0x00000000UL,    //bit_column_cksum[2][3];
        0x0000B08EUL, 0x00002CE5UL, 0x00000000UL,    //bit_column_cksum[3][3];
        0x00002AD9UL, 0x0000288BUL, 0x00000000UL,    //bit_column_cksum[4][3];
        0x00006C21UL, 0x00002A3DUL, 0x00000000UL,    //bit_column_cksum[5][3];
        0x000005AEUL, 0x000027E4UL, 0x00000000UL,    //bit_column_cksum[6][3];
        0x0000AF9BUL, 0x00002771UL, 0x00000000UL,    //bit_column_cksum[7][3];
        0x00000000UL, 0x0000000AUL, 0x0000F006UL, 0x00001E18UL, //row_weight_sum
        0x00000000UL, 0x000028F7UL, 0x0000EFD8UL, 0x0000108EUL  //fact_weight_sum
};
...
const composite_checksum_t csum_rom = {
        0x0018D080UL,    //total_ones
        0x0000EE76UL, 0x00003574UL, 0x00000003UL,    //bit_column_cksum[0][3];
        0x00003310UL, 0x00005F44UL, 0x00000003UL,    //bit_column_cksum[1][3];
        0x00008FFCUL, 0x000058A1UL, 0x00000003UL,    //bit_column_cksum[2][3];
        0x0000A548UL, 0x0000494AUL, 0x00000003UL,    //bit_column_cksum[3][3];
        0x00008F1DUL, 0x00003153UL, 0x00000003UL,    //bit_column_cksum[4][3];
        0x0000C8DFUL, 0x00003B5DUL, 0x00000003UL,    //bit_column_cksum[5][3];
        0x00002ACEUL, 0x00001F68UL, 0x00000003UL,    //bit_column_cksum[6][3];
        0x000074B3UL, 0x000025B0UL, 0x00000003UL,    //bit_column_cksum[7][3];
        0x00000000UL, 0x000000CFUL, 0x0000430AUL, 0x00001CB8UL, //row_weight_sum
        0x00000000UL, 0x00006588UL, 0x00006378UL, 0x00003105UL  //fact_weight_sum
};
