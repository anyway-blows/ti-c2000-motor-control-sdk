...
//*****************************************************************************
//
// Checks PLL clock correctness using the DCC module
//
// Parameters:
//  base            - (NOT USED) The DCC base module address
//  clk0src         - The clock source feeding the PLL (INTOSC, XTAL, etc)
//  clk1src         - The output clock source of the PLL (SYS or AUX)
//  dccCounterSeed0 - DCC counter 0 seed value
//  dccCounterSeed1 - DCC counter 1 seed value
//  dccValidSeed0   - DCC seed value that gets loaded into the valid
//                    duration counter for Counter 0
//
// This function uses the DCC module to verify that the PLL clock is
// configured and running as expected.
//
// Return: Returns "true" if DCC completes without error, otherwise returns
...
{
    //
    // Note: Parameter "base" is unused in this function
    //       but is left as part of the BROMDCC_verifySingleShotClock() to maintain
