...
#define SLAVE_NOT_READY_ERROR       0x3000U
...
// param: status is the value read from the PMBus status register
//
// return PMBus master lost arbitration returns true, otherwise false.
//
//*****************************************************************************
...
//        SLAVE_NOT_READY_ERROR - Returned if received NACK from slave
//
//*****************************************************************************
...
//*****************************************************************************
//
// Wait for PMBus slave ACK or NACK
//
//
// return API execution status
...
//*****************************************************************************
//
// Transmit only the Slave Address + EEPROM Address (No Data)
//
// param: eepromAddress is the EEPROM memory address
//
// return API execution status
