;;#############################################################################
;;! \file examples/common/dsp_error.asm
;;!
...
LF_SIZE     .set   4
    ...
    .page
    .if __TI_EABI__
    .asg DSP_Example_calcError, _DSP_Example_calcError
    .endif
    .global _DSP_Example_calcError
    .sect   ".text"
_DSP_Example_calcError:
    .asmfunc
...
;;-----------------------------------------------------------------------------
    ...
    B       _DSP_Example_calcError_ullcomp, GEQ
    NEG64   ACC:P
_DSP_Example_calcError_ullcomp:
...
_DSP_Example_calcError_ldcomp:
    ...
    B       _DSP_Example_calcError_fail, GEQ
    ADDB    AL, #1                  ; AL = 2 pass
    B       _DSP_Example_calcError_done, UNC
_DSP_Example_calcError_fail:
    MOVB    AL, #1                  ; AL = -1 (1 or 2 fail)
    NEG     AL
_DSP_Example_calcError_done:
    SUBB    SP, #LF_SIZE
    LRETR
