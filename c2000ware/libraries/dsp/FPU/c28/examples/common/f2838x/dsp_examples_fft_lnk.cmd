...
SECTIONS
{
   ...
   #endif
#endif
   .text           :>> RAMM0 | RAMM1 | RAMLS0 | RAMLS123,
                                  PAGE = 0
...
4(double precision) * 2(complex) * size of the FFT, for double precision \
routines and 2(single precision) * 2(complex) * size of the FFT, for \
single precision routines. \
For example, for a 128 point FFT, FFT_ALIGN=1024 for DP, and FFT_ALIGN=512\
