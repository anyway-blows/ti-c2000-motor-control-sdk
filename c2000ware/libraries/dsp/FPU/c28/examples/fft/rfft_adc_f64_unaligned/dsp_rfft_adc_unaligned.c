//#############################################################################
//
//! \file   dsp_rfft_adc_unaligned.c
//!
//! \brief  Runs the double precision Unaligned Real FFT (ADC input) routine
...
void DSP_runTest(void)
{
    ...
    CFFT_f64_setCalcFunction(hnd_cfft, (v_pfn_v)RFFT_adc_f64u);
