...
//!
//! \brief  Runs the single precision Real FFT routine (alternate) with 
...
void DSP_runTest(void)
{
    ...
    // Run the unaligned real FFT (alternate version)
    RFFT_f32u(hnd_rfft);
    ...
    // Run the scaled magnitude function
