//#############################################################################
//
//! \file   dsp_mpy_DP_CVxCV.c
//!
//! \brief  Multiplication of Two Complex Double Precision Vectors
...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('mpyCVbyCV', 64, 'TYPE_DOUBLE', 'FTYPE_C');
// "
...
void DSP_runTest(void)
{
    ...
    mpy_DP_CVxCV((complexf64_t *)test_output, (const complexf64_t *)test_input, 
