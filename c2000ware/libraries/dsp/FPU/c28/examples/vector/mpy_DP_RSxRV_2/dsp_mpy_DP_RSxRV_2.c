...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('mpyRSbyRV', 64, 'TYPE_DOUBLE', 'FTYPE_C');
// "
...
float64_t *test_scalar = &test_input[TEST_SIZE];
...
void DSP_runTest(void)
{
    ...
    mpy_DP_RSxRV_2((float64_t *)test_output, (const float64_t *)test_input, 
