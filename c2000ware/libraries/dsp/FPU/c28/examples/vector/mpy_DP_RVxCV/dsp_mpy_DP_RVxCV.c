//#############################################################################
//
//! \file   dsp_mpy_DP_RVxCV.c
//!
//! \brief  Multiplication of a Real Vector and a Complex Vector (Double 
//!         Precision)
...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('mpyRVbyCV', 64, 'TYPE_DOUBLE', 'FTYPE_C');
// "
...
// Also note the real vector is tacked on to the end of the complex vector
// in the input file
//
//#############################################################################
...
void DSP_runTest(void)
{
    ...
    mpy_DP_RVxCV((complexf64_t *)test_output, (const complexf64_t *)test_input,
