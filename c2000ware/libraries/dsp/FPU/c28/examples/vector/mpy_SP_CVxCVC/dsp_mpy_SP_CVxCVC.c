//#############################################################################
//
//! \file   dsp_mpy_SP_CVxCVC.c
//!
//! \brief  Single Precision Multiplication of a Complex Vector and the 
...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('mpyCVbyCVC', 64, 'TYPE_FLOAT', 'FTYPE_C');
// "
...
void DSP_runTest(void)
{
    ...
    mpy_SP_CVxCVC((complex_float *)test_output, 
