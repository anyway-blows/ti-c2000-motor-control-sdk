//#############################################################################
//
//! \file   dsp_mpy_SP_CVxCV.c
//!
//! \brief  Multiplication of Two Complex Single Precision Vectors
...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('mpyCVbyCV', 64, 'TYPE_FLOAT', 'FTYPE_C');
// "
...
void DSP_runTest(void)
{
    ...
    mpy_SP_CVxCV((complex_float *)test_output, 
