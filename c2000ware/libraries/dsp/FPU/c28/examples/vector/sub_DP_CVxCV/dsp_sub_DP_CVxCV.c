...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('subCVfromCV', 64, 'TYPE_DOUBLE', 'FTYPE_C');
// "
...
void DSP_runTest(void)
{
    ...
    sub_DP_CVxCV((complexf64_t *)test_output, (const complexf64_t *)test_input,
