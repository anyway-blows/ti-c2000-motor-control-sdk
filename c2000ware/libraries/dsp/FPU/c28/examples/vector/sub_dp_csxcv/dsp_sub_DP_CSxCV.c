...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('subCSfromCV', 64, 'TYPE_DOUBLE', 'FTYPE_C');
// "
...
void DSP_runTest(void)
{
    ...
    sub_DP_CSxCV((complexf64_t *)test_output, (const complexf64_t *)test_input, 
                        (const complexf64_t *)test_scalar, TEST_SIZE);
