//#############################################################################
//
//! \file   dsp_sub_SP_CSxCV.c
//!
//! \brief  Subtraction of a complex scalar element-wise from a complex vector.
...
// line as follows
// "
//   FPU_DSP_runVectorRoutines('subCSfromCV', 64, 'TYPE_FLOAT', 'FTYPE_C');
// "
...
// Also note the complex scalar is tacked on to the end of the complex 
...
// The complex scalar is tacked on to the end of the complex input
float *test_scalar = &test_input[2U*TEST_SIZE];
#ifdef __TI_EABI__
#ifdef __cplusplus
...
void DSP_runTest(void)
{
    ...
    sub_SP_CSxCV((complex_float *)test_output, 
                 (const complex_float *)test_input, c, TEST_SIZE);
