...
_FPU_CFFTF32vars1Stages1and2andBitReverse_casm:
        ...
        NOP         *BR0++
        MOV32       R2H,*++                ; R2H = D1
        ADDF32      R7H,R0H,R2H            ; R7H = (D0 + D1)
        ||MOV32     R3H,*--                ; R3H = I1
        NOP         *BR0++
        ADDF32      R6H,R1H,R3H            ; R6H = (I0 + I1)
        ||MOV32     R4H,*++                ; R4H = D2
        SUBF32      R0H,R0H,R2H            ; R0H = (D0 - D1)
        ||MOV32     R5H,*--                ; R5H = I2
        NOP         *BR0++
        SUBF32      R2H,R1H,R3H            ; R2H = (I0 - I1)
        ||MOV32     R1H,*++                ; R1H = D3
        ADDF32      R3H,R4H,R1H            ; R3H = (D2 + D3)
        SUBF32      R4H,R4H,R1H            ; R4H = (D2 - D3)
        ADDF32      R1H,R7H,R3H            ; R1H = (D0 + D1) + (D2 + D3)
        SUBF32      R7H,R7H,R3H            ; R7H = (D0 + D1) - (D2 + D3)
        ||MOV32     R3H,*--                ; R3H = I3
        NOP         *BR0++
        ADDF32      R1H,R5H,R3H            ; R1H = (I2 + I3)
        ||MOV32     *XAR2++,R1H
        SUBF32      R5H,R5H,R3H            ; R5H = (I2 - I3)
        ADDF32      R3H,R6H,R1H            ; R3H = (I0 + I1) + (I2 + I3)
        SUBF32      R6H,R6H,R1H            ; R6H = (I0 + I1) - (I2 + I3)
        ADDF32      R1H,R0H,R5H            ; R1H = (D0 - D1) + (I2 - I3)
        ||MOV32     *XAR2++,R3H
        SUBF32      R3H,R0H,R5H            ; R3H = (D0 - D1) - (I2 - I3)
        SUBF32      R5H,R2H,R4H            ; R5H = (I0 - I1) - (D2 - D3)
        ||MOV32     *XAR2++,R1H
        ADDF32      R0H,R2H,R4H            ; R0H = (I0 - I1) + (D2 - D3)
        MOV32       *XAR2++,R5H
        MOV32       *XAR2++,R7H
        MOV32       *XAR2++,R6H
        MOV32       *XAR2++,R3H
...
;;-----------------------------------------------------------------------------
;;               +--------+--------+--------+--------+--------+--------+--------+---------+----
;; InPtr  OutPtr | St3 | Stage4 | Stage5 | Stage6 | Stage7 | Stage8 | Stage9 | Stage10 | ...
;;               +--------+--------+--------+--------+--------+--------+--------+---------+----
...
CFFTF32vars1Stages3UpStageLoop:                
        ...
        .align      2
        MOV32       R1H,*++,ARP4        ; XAR3->D1_1
CFFTF32vars1Stages3UpOuterLoop:
        MOV32       R2H,*0++,ARP3       ; XAR4->COS_1
        MPYF32      R7H,R1H,R2H         ;                : R7H = D1_1*COS_1
        ||MOV32     R0H,*++,ARP5        ; XAR3->I1_1
        MOV32       R3H,*0++,ARP3       ; XAR5->SIN_1
        MPYF32      R6H,R0H,R3H         ;                : R6H = I1_1*SIN_1
        MPYF32      R5H,R1H,R3H         ;                : R5H = D1_1*SIN_1

        RPTB        CFFTF32vars1Stages3UpInnerLoop,@AL
        ADDF32      R7H,R7H,R6H         ;                : R7H = (D1_1*COS_1 + I1_1*SIN_1)
        ||MOV32     R1H,*++,ARP2        ; XAR3->D1_2
        MPYF32      R6H,R0H,R2H         ;                : R6H = I1_1*COS_1
        ||MOV32     R3H,*++,ARP4        ; XAR2->D0_1
        ADDF32      R4H,R3H,R7H         ;                : R4H = D0_1 + (D1_1*COS_1 + I1_1*SIN_1)
        ||MOV32     R2H,*0++,ARP3       ; XAR4->COS_2
        SUBF32      R6H,R6H,R5H         ;                : R6H = (I1_1*COS_1 - D1_1*SIN_1)
        ||MOV32     R0H,*++,ARP6        ; XAR3->I1_2
        SUBF32      R4H,R3H,R7H         ;                : R4H = D0_1 - (D1_1*COS_1 + I1_1*SIN_1)
        ||MOV32     *++,R4H,ARP2        ; XAR6->D0_1
        MPYF32      R7H,R1H,R2H         ;                : R7H = D1_2*COS_2
        ||MOV32     R3H,*++,ARP7        ; XAR2->I0_1
        ADDF32      R4H,R3H,R6H         ;                : R4H = I0_1 + (I1_1*COS_1 - D1_1*SIN_1)
        ||MOV32     *++,R4H,ARP5        ; XAR7->D1_1
        SUBF32      R5H,R3H,R6H         ;                : R5H = I0_1 - (I1_1*COS_1 - D1_1*SIN_1)
        ||MOV32     R3H,*0++,ARP6       ; XAR5->SIN_2
        MPYF32      R6H,R0H,R3H         ;                : R6H = I1_2*SIN_2
        ||MOV32     *++,R4H,ARP7        ; XAR6->I0_1
        MPYF32      R5H,R1H,R3H         ;                : R5H = D1_2*SIN_2
        ||MOV32     *++,R5H,ARP3        ; XAR7->I1_1
CFFTF32vars1Stages3UpInnerLoop:
        ...
        ADDF32      R7H,R7H,R6H         ;                : R7H = (D1_2*COS_2 + I1_2*SIN_2)
        ||MOV32     R6H,*--,ARP2        ; XAR3 = XAR3 - 2
        MPYF32      R6H,R0H,R2H         ;                : R6H = I1_2*COS_2
        ||MOV32     R3H,*++,ARP3        ; XAR2->D0_2
        ADDF32      R4H,R3H,R7H         ;                : R4H = D0_2 + (D1_2*COS_2 + I1_2*SIN_2)
        SUBF32      R6H,R6H,R5H         ;                : R6H = (I1_2*COS_2 - D1_2*SIN_2)
        ||MOV32     R5H,*0++,ARP6       ; XAR3 = XAR3 + DataPtrInc
        SUBF32      R4H,R3H,R7H         ;                : R4H = D0_2 - (D1_2*COS_2 + I1_2*SIN_2)
        ||MOV32     *++,R4H,ARP2        ; XAR6->D0_2
        MOV32       R3H,*0++,ARP7       ; XAR2->I0_2, XAR2 = XAR2 + DataPtrInc
        ADDF32      R4H,R3H,R6H         ;                : R4H = I0_2 + (I1_2*COS_2 - D1_2*SIN_2)
        ||MOV32     *++,R4H,ARP3        ; XAR7->D1_2
        SUBF32      R5H,R3H,R6H         ;                : R5H = I0_2 - (I1_2*COS_2 - D1_2*SIN_2)
        ||MOV32     R1H,*++,ARP6        ; XAR3->D1_1
        MOV32       *0++,R4H,ARP7       ; XAR6->I0_2, XAR6 = XAR6 + DataPtrInc
        MOV32       *0++,R5H,ARP4       ; XAR7->I1_2, XAR7 = XAR7 + DataPtrInc
        MOVZ        AR0,@@_CFFTF32_vars_CoefPtrInc
