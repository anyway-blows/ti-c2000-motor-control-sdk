;;#############################################################################
;;! \file source/fft/CFFT_f32i.asm
;;!
;;! \brief  Complex FFT (in-place)
;;! \author C2000
;;
;; DESCRIPTION:
;;
...
;; FUNCTIONS:
;;
;;    void CFFT_f32i (CFFT_F32_STRUCT_Handle)
;;
...
;;
;; ASSUMPTIONS:
;;     * The input has been bit-reversed prior to calling this function
;;     * Input and Output pointers point to the same buffer
...
;===========================================================================
; Function: void CFFT_f32i(CFFT_F32_STRUCT_Handle)
;===========================================================================
; _FPU_CFFTF32vars1Stages1and2_casm();
; _FPU_CFFTF32vars1Stages3Up();
;
        .if __TI_EABI__
        .asg CFFT_f32i, _CFFT_f32i
        .endif
...
_CFFT_f32i:
        ...
        LCR          _FPU_CFFTF32vars1Stages1and2_casm
        MOVL         XAR4,*-SP[2]
