;;#############################################################################
;;! \file source/fpu64/fft/cfft_f64_mag.asm
;;!
;;! \brief  Complex Fast Fourier Transform Magnitude (Double Precision)
...
;; FUNCTIONS:
;;
;;  void CFFT_f64_mag (CFFT_F64_Handle)
;;  
...
;;*****************************************************************************
    .if __TI_EABI__
    .asg CFFT_f64_mag, _CFFT_f64_mag
    .endif

    .page
    .global _CFFT_f64_mag
    .sect   ".text"
_CFFT_f64_mag:
    .asmfunc
