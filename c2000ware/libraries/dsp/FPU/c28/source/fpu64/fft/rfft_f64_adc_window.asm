;;#############################################################################
;;! \file source/fft/rfft_f64_adc_window.asm.asm
;;!
...
;;| DATE     | AUTHOR        | CHANGE                                         |
;;+----------+---------------+------------------------------------------------+
;;| 05/03/19 | Ritvik Sadana | Replaced RFFT_f64_adc_win with RFFT_adc_f64_win|
...
;;*****************************************************************************
    ...
    .if __TI_EABI__
    .asg    RFFT_adc_f64_win, _RFFT_adc_f64_win
    .endif
    
    .global _RFFT_adc_f64_win
;;
;;=============================================================================
;;! \fn RFFT_adc_f64_win
;;! \brief Real FFT (ADC input) Windowing Function
...
;;
;; This function is identical to _RFFT_adc_f32_win. It is replicated here so 
;; as to avoid conflicting ISA issues when including both the fpu32 and fpu64 
;; libraries. It will window a 2N-point real valued data sequence stored as an 
...
_RFFT_adc_f64_win:
    ...
    .align  2
    RPTB    _RFFT_adc_f64_win_loop1, AR7
