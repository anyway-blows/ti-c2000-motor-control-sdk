...
//! \brief  Division: signed int (32-bit) / signed int (32-bit)
...
// FID_i32byi32_t
//*****************************************************************************
void FID_i32byi32_t(const int32_t num, const int32_t den, 
...
// FID_i32byi32_m
//*****************************************************************************
void FID_i32byi32_m(const int32_t num, const int32_t den, 
                           int32_t *p_quo, int32_t *p_rem)
{
    int16_t i;
    static int16_t iter = 1;
...
// FID_i32byi32_e
//*****************************************************************************
void FID_i32byi32_e(const int32_t num, const int32_t den, 
                           int32_t *p_quo, int32_t *p_rem)
{
    int16_t i;
    static int16_t iter = 1;
