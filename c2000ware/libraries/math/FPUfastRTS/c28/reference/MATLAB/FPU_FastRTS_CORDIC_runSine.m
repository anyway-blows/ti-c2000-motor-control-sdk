...
%% Function Prototype
%  An Example: Generate a 64 Sine input/output vector along with a 64
%  entry CORDIC arctangents and scale factor tables.
%
%  [S,R,AE,RE] = FPU_FastRTS_CORDIC_runSine(64, [-pi,pi], 'TYPE_FLOAT',
%  'FPU_FastRTS_cordicTable.asm', 'cordic_sinInput.asm', 
%  'cordic_sinOutput.asm')
%
% or
%
%  [S,R,AE,RE] = FPU_FastRTS_CORDIC_runSine(64, [-pi,pi], 'TYPE_FLOAT',
%  'FPU_FastRTS_cordicTable.c', 'cordic_sinInput.c', 'cordic_sinOutput.c')
%
function [SIN,REF,AERR,RERR] = FPU_FastRTS_CORDIC_runSine(N, SWP, varargin)
%% Parse Arguments
nOptArgs = 4;
...
figure;
subplot(2,2,1), plot(t,SIN,'-b',t,REF,'--r'), legend('CORDIC Sine',...
    'Reference MATLAB Sine'), xlabel('theta'), ylabel('Amplitude'),
title('Sine: CORDIC'), grid on;
