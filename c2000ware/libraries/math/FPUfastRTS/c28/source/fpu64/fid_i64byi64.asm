;;#############################################################################
;;! \file source/fpu64/fid_i64byi64.asm
;;!
;;! \brief  Signed Long Integer (64-bit) Division
;;! \author Vishal Coelho  
;;! \date   04/12/2016 
;;
;; DESCRIPTION:
;;
;;   This function performs a 64-bit signed division (truncated, modulo or
;;   euclidean)
;;
;; FUNCTIONS:
;;
...
;;*****************************************************************************
    .page
    .if __TI_EABI__
    .asg    FID_i64byi64_t, _FID_i64byi64_t
    .endif
    .global _FID_i64byi64_t
    .sect   ".text"
_FID_i64byi64_t:
    .asmfunc
...
;;*****************************************************************************
    .page
    .if __TI_EABI__
    .asg    FID_i64byi64_m, _FID_i64byi64_m
    .endif
    .global _FID_i64byi64_m
    .sect   ".text"
_FID_i64byi64_m:
    .asmfunc
    MOV32        R0H, *+XAR4[0] ; [R1H:R0H] = dividend
...
;;*****************************************************************************
    .page
    .if __TI_EABI__
    .asg    FID_i64byi64_e, _FID_i64byi64_e
    .endif
    .global _FID_i64byi64_e
    .sect   ".text"
_FID_i64byi64_e:
    .asmfunc
    MOV32        R0H, *+XAR4[0] ; [R1H:R0H] = dividend
