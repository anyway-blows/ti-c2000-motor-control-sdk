...
exports = {
    ...
    allInputsAry      : [
        ...
        { name: 'FSM_2.S0' },
        { name: 'FSM_2.S1' },
        { name: 'COUNTER_0.count_zero' },
        { name: 'COUNTER_0.count_match1' },
        { name: 'COUNTER_0.count_match2' },
        { name: 'COUNTER_1.count_zero' },
        { name: 'COUNTER_1.count_match1' },
        { name: 'COUNTER_1.count_match2' },
        { name: 'COUNTER_2.count_zero' },
        { name: 'COUNTER_2.count_match1' },
        { name: 'COUNTER_2.count_match2' }
    ],
    ...
    altInputsAry        : [
        ...
        {name: "OUTLUT_6.out" },
        {name: "OUTLUT_7.out" },
        {name: "OUTLUT_0_INVERTED" },
        {name: "OUTLUT_1_INVERTED" },
        {name: "OUTLUT_2_INVERTED" },
        {name: "OUTLUT_3_INVERTED" },
        {name: "OUTLUT_4_INVERTED" },
        {name: "OUTLUT_5_INVERTED" },
        {name: "OUTLUT_6_INVERTED" },
        {name: "OUTLUT_7_INVERTED"},
        {name: "BOUNDARY_OUT.out0" },
        {name: "BOUNDARY_OUT.out1" },
        {name: "BOUNDARY_OUT.out2" },
        {name: "BOUNDARY_OUT.out3" },
        {name: "BOUNDARY_OUT.out4" },
        {name: "BOUNDARY_OUT.out5" },
        {name: "BOUNDARY_OUT.out6" },
        {name: "BOUNDARY_OUT.out7" },
        {name: "BOUNDARY_OUT_out0_INVERTED" },
        {name: "BOUNDARY_OUT_out1_INVERTED" },
        {name: "BOUNDARY_OUT_out2_INVERTED" },
        {name: "BOUNDARY_OUT_out3_INVERTED" },
        {name: "BOUNDARY_OUT_out4_INVERTED" },
        {name: "BOUNDARY_OUT_out5_INVERTED" },
        {name: "BOUNDARY_OUT_out6_INVERTED" },
        {name: "BOUNDARY_OUT_out7_INVERTED" },
    ],
    ...
    inputs : {
        ...
        HLC      : ['e0','e1','e2','e3'],
        BOUNDARY : ['in0','in1','in2','in3','in4','in5','in6','in7'],
        AOC      : ['in', 'gate', 'release']
    }
};
