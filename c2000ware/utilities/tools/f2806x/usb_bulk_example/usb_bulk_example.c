...
//****************************************************************************
LPTSTR
GetSystemErrorString(DWORD dwError)
{
    DWORD dwRetcode;
...
//****************************************************************************
//
// UpdateThroughput - Print the throughput in terms of Kbps once per second.
//
//****************************************************************************
void
UpdateThroughput(void)
{
    ...
    //
    ulElapsed = (ulNow > ulStartTime) ? (ulNow - ulStartTime) : 
                (ulStartTime - ulNow);
    ...
    if(hUSB)
    {
        ...
        if(bEcho)
        {
            ...
            while(1)
            {
                ...
                //
                dwError = ReadUSBPacket(hUSB, szBuffer, ECHO_PACKET_SIZE, 
