...
expAdd("motorVars.RsOnLine_Ohm",getNatural())
expAdd("motorVars.RoverL_rps",getNatural())
...
expAdd("angleGen")
expAdd("IdqSet_A.value[0]",getNatural())	
expAdd("IdqSet_A.value[1]",getNatural())
expAdd("Idq_ref_A.value[0]",getNatural())
expAdd("Idq_ref_A.value[1]",getNatural())
expAdd("Idq_in_A.value[0]",getNatural())
expAdd("Idq_in_A.value[1]",getNatural())
expAdd("pi_Id.refValue",getNatural())
expAdd("pi_Id.fbackValue",getNatural())
expAdd("pi_Iq.refValue",getNatural())
expAdd("pi_Iq.fbackValue",getNatural())