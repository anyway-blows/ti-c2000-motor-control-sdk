...
expAdd("motorVars.flagEnableFWC",getDecimal())
expAdd("motorVars.flagEnableMTPA",getDecimal())
expAdd("motorVars.flagUpdateMTPAParams",getDecimal())
expAdd("motorVars.mtpaKconst")
expAdd("motorVars.angleCurrent_rad")
expAdd("motorVars.IsRef_A")
expAdd("Idq_ref_A.value[0]")
expAdd("Idq_ref_A.value[1]")
