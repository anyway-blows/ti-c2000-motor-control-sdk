...
//! \file   solutions/drv8312_c2_kit/f28004x/drivers/hal.h
...
//!
#define HAL_PWM_DBFED_CNT         5             // 50ns

//! \brief Defines the PWM deadband rising edge delay count (system clocks)
//!
#define HAL_PWM_DBRED_CNT         5             // 50ns
...
static inline void HAL_readADCDataWithoutOffsets(HAL_Handle handle,HAL_ADCData_t *pADCData)
{
  ...
  pADCData->throttle = (float32_t)ADC_readResult(obj->adcResult[1], ADC_SOC_NUMBER3);
